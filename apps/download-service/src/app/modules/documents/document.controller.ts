...
import { DocumentClient } from '@island.is/clients/postholf'
...
export class DocumentController {
  ...
  async create(@Body() resource: GetDocumentDto, @Res() res: Response) {
    const rawDocumentDTO = await this.documentClient.customersDocument({
      kennitala: resource.token,
      messageId: resource.documentId,
      authenticationType: 'HIGH',
    })

    const pdf = rawDocumentDTO.content ?? this.base64
