  ...
  return service('api')
    ...
    .secrets({
      ...
      FISKISTOFA_ACCESS_TOKEN_SERVICE_CLIENT_SECRET:
        '/k8s/api/FISKISTOFA_ACCESS_TOKEN_SERVICE_CLIENT_SECRET',
      FISKISTOFA_ACCESS_TOKEN_SERVICE_URL:
        '/k8s/api/FISKISTOFA_ACCESS_TOKEN_SERVICE_URL',
      FISKISTOFA_ACCESS_TOKEN_SERVICE_CLIENT_ID:
        '/k8s/api/FISKISTOFA_ACCESS_TOKEN_SERVICE_CLIENT_ID',
      FISKISTOFA_ACCESS_TOKEN_SERVICE_AUDIENCE:
        '/k8s/api/FISKISTOFA_ACCESS_TOKEN_SERVICE_AUDIENCE',
    })
    .xroad(
      AdrAndMachine,
      Firearm,
