...
export const serviceSetup = (services: {
  ...
  return service('api')
    ...
    .secrets({
      ...
      COMPLAINTS_COMMITTEE_RULINGS_API_KEY: '/k8s/api/COMPLAINTS_COMMITTEE_RULINGS_API_KEY',
      COMPLAINTS_COMMITTEE_RULINGS_API_BASE_PATH: '/k8s/api/COMPLAINTS_COMMITTEE_RULINGS_API_BASE_PATH',
