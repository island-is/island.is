...
export const serviceSetup = (services: {
  ...
  return service('api')
    ...
    .secrets({
      ...
      DRIVING_LICENSE_XROAD_PATH_V2: '/k8s/api/DRIVING_LICENSE_XROAD_PATH_V2',
      ...
      HEALTH_INSURANCE_V2_XROAD_USERNAME: '/k8s/api/HEALTH_INSURANCE_V2_XROAD_USERNAME',
      HEALTH_INSURANCE_V2_XROAD_PASSWORD: '/k8s/api/HEALTH_INSURANCE_V2_XROAD_PASSWORD',
    })
