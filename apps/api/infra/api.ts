  ...
  return service('api')
    ...
    .secrets({
      ...
      FINANCIAL_STATEMENTS_INAO_BASE_PATH:
        '/k8s/api/FINANCIAL_STATEMENTS_INAO_BASE_PATH',
      FINANCIAL_STATEMENTS_INAO_ISSUER:
        '/k8s/api/FINANCIAL_STATEMENTS_INAO_ISSUER',
      FINANCIAL_STATEMENTS_INAO_SCOPE:
        '/k8s/api/FINANCIAL_STATEMENTS_INAO_SCOPE',
      FINANCIAL_STATEMENTS_INAO_TOKEN_ENDPOINT:
        '/k8s/api/FINANCIAL_STATEMENTS_INAO_TOKEN_ENDPOINT',
