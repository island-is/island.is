...
@Module({
  ...
  imports: [
    ...
    ApiDomainsPaymentModule.register({
      XROAD_PROVIDER_ID: environment.paymentDomain.XROAD_PROVIDER_ID,
      XROAD_BASE_URL: environment.paymentDomain.XROAD_BASE_URL,
      XROAD_CLIENT_ID: environment.xroad.clientId,
      PAYMENT_PASSWORD: environment.paymentDomain.PAYMENT_PASSWORD,
      PAYMENT_USERNAME: environment.paymentDomain.PAYMENT_USERNAME,
      CALLBACK_BASE_URL: environment.paymentDomain.CALLBACK_BASE_URL,
      CALLBACK_ADDITION_URL: environment.paymentDomain.CALLBACK_ADDITION_URL,
      ARK_BASE_URL: environment.paymentDomain.ARK_BASE_URL,
    }),
