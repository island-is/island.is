...
- Now start your services, but make sure your services ports have been replaced by the ports provided by Mountebank. In this example's case, that would be `XROAD_BASE_PATH=http://localhost:9388 yarn start api`
