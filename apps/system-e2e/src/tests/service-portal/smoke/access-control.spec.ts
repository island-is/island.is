...
test.describe('Service portal, access control', () => {
  ...
  test('can remove delegations', async () => {
    // Arrange
  ...
  test('can create delegation', async () => {
    // Arrange
    const page = await context.newPage()
    await page.goto('/minarsidur/adgangsstyring/umbod')
  ...
  test('can sign in with custom delegation', async ({ browser }) => {
    // Arrange
