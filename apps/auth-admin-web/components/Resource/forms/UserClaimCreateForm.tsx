...
const UserClaimCreateForm: React.FC<Props> = (props: Props) => {
  const [claim, setClaim] = useState<UserClaimDTO>(new UserClaimDTO())
  const { register, handleSubmit, errors, formState } = useForm<UserClaimDTO>()
          ...
          <div className="user-claim-create-form__container__form">
            ...
            <form onSubmit={handleSubmit(save)}>
              <div className="user-claim-create-form__container__fields">
                <div className="user-claim-create-form__container__checkbox__field">
                  <label
