...
import { PersonalRepresentativeScopePermissionDTO } from '../entities/dtos/personal-representative-scope-permisson.dto'
...
export class ResourcesService extends BaseService {
  ...
  static async getPersonalRepresentativePermissionTypes(): Promise<
    PersonalRepresentativePermissionType[]
  > {
