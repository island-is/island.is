...
import article from '@island.is/web/pages/article'

const GetArticleByIdQuery = gql`
  query GetArticleByIdQuery {
    article(input: { id: "3DLRRLt4Nf4jedqgT4SkyI" }) {
      content
      title
    }
  }
...
const articleScreen = (articleId: string) => {
  const Article = ({ article }) => {
    ...
    // const { data, loading, error } = useQuery(GetArticleByIdQuery)
                    ...
                    top={
                      <Stack space={[2, 2]}>
                        ...
                        <Typography variant="p" as="p">
                          ...
                          forsjáraðilinn nafngjöf hér. Hinn forsjáraðilinn
                          fyllir út formið Nafngjöf – staðfesting innan 3
                          sólarhringa. Ef nafngjöf er ekki staðfest telst
                          skráning ekki fullnægjandi og verður hafnað í
                          þjóðskrá.
                        </Typography>
                        <Typography variant="p" as="p">
                          Ef einn fer með forsjá barns fyllir hann út skráningu
                          og sendir. Ef barn hefur ekki verið feðrað þá er ekki
                          hægt að kenna það við föður.
                        </Typography>
                      </Stack>
                    }
                    bottom={
                  ...
                  <ArticleSection
                    top={
                      <Stack space={[2, 2]}>
                        ...
                        <Typography variant="intro" as="p">
                          Beiðni til mannanafnanefndar um eiginnafn eða
                          millinafn, sem ekki er á mannanafnaskrá.
                        </Typography>
                        <Typography variant="p" as="p">
