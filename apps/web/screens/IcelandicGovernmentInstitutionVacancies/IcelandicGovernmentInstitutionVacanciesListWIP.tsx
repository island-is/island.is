...
const IcelandicGovernmentInstitutionVacanciesListWIP: Screen<
...
> = ({ vacancies, namespace, fetchErrorOccurred }) => {
  ...
  const pathname = linkResolver('vacancieswip').href
    ...
    .map((vacancy) => {
      ...
      return {
        ...
        link: {
          ...
          href: linkResolver('vacancydetailswip', [
            vacancy.id?.toString() || '',
          ]).href,
        },
        tags,
...
IcelandicGovernmentInstitutionVacanciesListWIP.getProps = async ({
  apolloClient,
  locale,
}) => {
...
export default withMainLayout(
  withCustomPageWrapper(
    ...
    IcelandicGovernmentInstitutionVacanciesListWIP,
  ),
  {
