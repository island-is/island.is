...
interface IcelandicGovernmentInstitutionVacancyDetailsV2Props {
  vacancy: Vacancy
  namespace: Record<string, string>
}

const IcelandicGovernmentInstitutionVacancyDetailsV2: Screen<
  IcelandicGovernmentInstitutionVacancyDetailsV2Props
> = ({ vacancy, namespace }) => {
...
IcelandicGovernmentInstitutionVacancyDetailsV2.getProps = async ({
  apolloClient,
  query,
  locale,
}) => {
...
export default withMainLayout(IcelandicGovernmentInstitutionVacancyDetailsV2)
