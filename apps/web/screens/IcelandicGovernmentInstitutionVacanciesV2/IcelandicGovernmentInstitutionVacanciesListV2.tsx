...
import { shortenText, VACANCY_INTRO_MAX_LENGTH } from './utils'
import * as styles from './IcelandicGovernmentInstitutionVacanciesListV2.css'

const ITEMS_PER_PAGE = 8

interface IcelandicGovernmentInstitutionVacanciesListV2Props {
  vacancies: any[]
  namespace: Record<string, string>
}

const IcelandicGovernmentInstitutionVacanciesListV2: Screen<
  IcelandicGovernmentInstitutionVacanciesListV2Props
> = ({ namespace, vacancies }) => {
...
IcelandicGovernmentInstitutionVacanciesListV2.getProps = async ({
  apolloClient,
  locale,
}) => {
...
export default withMainLayout(IcelandicGovernmentInstitutionVacanciesListV2, {
