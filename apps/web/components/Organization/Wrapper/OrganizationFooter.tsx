...
import {Box, GridColumn, GridContainer, GridRow, Link, Stack, Text} from '@island.is/island-ui/core'
    ...
    <footer aria-labelledby="organizationFooterTitle" className={styles.footer}>
      <GridContainer>
        <Box paddingTop={[2, 2, 0]} paddingBottom={[0, 0, 4, 4]}>
          <Box display="flex" flexDirection="row" alignItems="center" className={styles.footerTitleWrapper}>
            <img
