...
export interface OpenApiViewProps {
  ...
  selectedInstanceOption?: SelectOption
  selectedVersionOption?: SelectOption
}
//ToDO : One type for SelectOption that is exported
type SelectOption = {
  label: string
  value: any
}
...
export const OpenApiView = ({
  ...
  console.log('OpenApiPropsSelectedVersionOption: ', selectedVersionOption)
  ...
  const [openApiInput, setOpenApiInput] = useState<GetOpenApiInput>(
    selectOptionValueToGetOpenApiInput(selectedVersionOption),
  )
