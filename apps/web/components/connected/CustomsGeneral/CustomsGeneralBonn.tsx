...
import { GET_CUSTOMS_GENERAL_BONN } from '@island.is/web/screens/queries/CustomsGeneral'

import { CustomsGeneralDateTable, toApiDate } from './CustomsGeneralDateTable'
import { m } from './translation.strings'

const CustomsGeneralBonn = () => {
  ...
  const { data, loading, error } = useQuery(GET_CUSTOMS_GENERAL_BONN, {
    variables: { input: { dags: toApiDate(selectedDate), kerfi: 'I' } },
  })

  const items = (data?.customsGeneralBonn ?? []).map(
...
export default CustomsGeneralBonn
