...
const DEFAULT_GRANT_OPTIONS = [
  {
    ...
    value: 'Styrktarsjóður barna- og unglingageðdeildar',
  },
  {
    label: 'Styrktarsjóður Barnaspítala Hringsins',
    value: 'Styrktarsjóður Barnaspítala Hringsins',
  },
  {
    label: 'Styrktarsjóður Blóðbankans',
    value: 'Styrktarsjóður Blóðbankans',
  },
  {
    label: 'Styrktarsjóður bráðasviðs',
    value: 'Styrktarsjóður bráðasviðs',
  },
  {
    label: 'Styrktarsjóður endurhæfingar',
    value: 'Styrktarsjóður endurhæfingar',
  },
  {
    label: 'Styrktarsjóður geðsviðs',
    value: 'Styrktarsjóður geðsviðs',
  },
  {
    label: 'Styrktarsjóður gjörgæslu',
    value: 'Styrktarsjóður gjörgæslu',
  },
  {
    label: 'Styrktarsjóður hjartadeildar',
    value: 'Styrktarsjóður hjartadeildar',
  },
  {
    label: 'Styrktarsjóður kvenna- og fæðingardeildar',
    value: 'Styrktarsjóður kvenna- og fæðingardeildar',
  },
  {
    label: 'Styrktarsjóður Landspítala',
    value: 'Styrktarsjóður Landspítala',
  },
  {
    label: 'Styrktarsjóður lyflækningadeilda',
    value: 'Styrktarsjóður lyflækningadeilda',
  },
  {
    label: 'Styrktarsjóður myndgreininga',
    value: 'Styrktarsjóður myndgreininga',
  },
  {
    label: 'Styrktarsjóður rannsóknarstofa',
    value: 'Styrktarsjóður rannsóknarstofa',
  },
  {
    label: 'Styrktarsjóður skurðlækningadeildar',
    value: 'Styrktarsjóður skurðlækningadeildar',
  },
  {
    label: 'Styrktarsjóður öldrunar',
    value: 'Styrktarsjóður öldrunar',
  },
]
