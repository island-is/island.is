...
const staffSeeds = `[
    {
      ...
      "active" : true,
      "municipality_name" : "Hfj",
      "national_id" : "0000000002",
      "municipality_id" : "1400",
      "municipality_homepage" : "hfj.is",
    ...
    },
    {
      ...
      "phone_number" : null,
      "active" : true,
      "municipality_name" : "Snæfellsbær",
      "national_id" : "0101302399",
      "municipality_id" : "3714",
...
module.exports = {
  up: (queryInterface, Sequelize) => {
    var model = queryInterface.sequelize.define('staff', {
      ...
      municipality_homepage: Sequelize.STRING,
      national_id: Sequelize.STRING,
      municipality_id: Sequelize.STRING,
      municipality_name: Sequelize.STRING,
