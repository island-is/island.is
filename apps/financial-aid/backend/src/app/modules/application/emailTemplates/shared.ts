...
<tr> 
<td align="left" style="padding:0;Margin:0;padding-bottom:25px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#00003c;font-size:14px">Umsækjandi hefur svarað stöðunni <em>Vantar upplýsingar</em> með því að hlaða upp gögnum í gegnum stöðusíðu umsóknarinnar. Þetta er í raun sama staða og staðan Úrvinnsla og textinn í taginu Ný gögn birtist eingöngu ef ekki hefur verið smellt á umsóknina eftir að ný gögn bárust.</p></td> 
</tr> 
<tr> 
