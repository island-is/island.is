                 ...
                 <tr> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     ...
                     <tr> 
                      <td align="left" style="padding:0;Margin:0;padding-top:20px;padding-bottom:20px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'IBM Plex Sans', 'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#00003c;font-size:18px">Ef þú sem stjórnandi hefur einnig áhuga á að vinna umsóknir um fjárhagsaðstoð getur þú valið um það með því að fara í þínar notendastillingar vinstra megin í viðmótinu og hakað við <em>Ég vil geta séð og tekið að mér mál</em>.</p></td> 
                     </tr> 
                     <tr> 
