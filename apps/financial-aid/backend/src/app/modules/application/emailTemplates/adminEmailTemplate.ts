...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="font-family:'IBM Plex Sans', 'open sans', 'helvetica neue', helvetica, arial, sans-serif">
 <head> 
  ...
  <title>Nýr stjórnandi í Veitu</title> 
  <!--[if (mso 16)]>
    <style type="text/css">
    ${fonts}
                 ...
                 <tr> 
                  <td valign="top" align="center" style="padding:0;Margin:0;width:540px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                        ${header(
                          `Þú ert nú stjórnandi í Veitu – vinnslukerfi umsókna um fjárhagsaðstoð`,
                        )} 
                     </tr> 
                   </table></td> 
                 </tr> 
                 ...
                 <tr> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                    ...
                    ${addUsers}
                    ${handleApplications(
                      `Ef þú sem stjórnandi hefur einnig áhuga á að vinna umsóknir um fjárhagsaðstoð getur þú valið um það með því að fara í þínar notendastillingar vinstra megin í viðmótinu og hakað við <em>Ég vil geta séð og tekið að mér mál</em>.`,
                    )}
                   </table></td> 
                 </tr> 
               </table></td> 
