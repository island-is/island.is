...
import { FamilyMemberCard } from '@/ui/lib/card/family-member-card'
import styled, { useTheme } from 'styled-components/native'
import { useIntl } from 'react-intl'
import { MoreCard } from '@/ui/lib/card/more-card'
  ...
  return (
    <ScrollView style={{ flex: 1, paddingHorizontal: 16, paddingVertical: 16 }}>
      <SafeAreaView style={{ marginBottom: theme.spacing[1] }}>
        ...
        >
          <FamilyMemberCard name="Testing" nationalId="010101-1234" />
        </TouchableHighlight>
      </SafeAreaView>
      <Row>
        <MoreCard
