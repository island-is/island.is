...
export const en: TranslatedMessages = {
  ...
  'health.appointments.weekday.0': 'Sunday',
  'health.appointments.weekday.1': 'Monday',
  'health.appointments.weekday.2': 'Tuesday',
  'health.appointments.weekday.3': 'Wednesday',
  'health.appointments.weekday.4': 'Thursday',
  'health.appointments.weekday.5': 'Friday',
  'health.appointments.weekday.6': 'Saturday',
