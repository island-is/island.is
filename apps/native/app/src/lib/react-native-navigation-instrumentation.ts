...
import { BeforeNavigate } from "@sentry/react-native/dist/js/tracing/reactnativetracing";
import { RoutingInstrumentation, TransactionCreator } from "@sentry/react-native/dist/js/tracing/routingInstrumentation";
import { ComponentWillAppearEvent, EventsRegistry } from "react-native-navigation";

const getBlankTransactionContext = (
  name: string
): TransactionContext => {
  return {
    name: "Route Change",
...
export class ReactNativeNavigationInstrumentation extends RoutingInstrumentation {
  ...
  private _stateChangeTimeout?: NodeJS.Timeout | undefined;
