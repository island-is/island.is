...
export const ApplictionsInProgressScreen: NavigationFunctionComponent = ({
  componentId,
}) => {
        ...
        <StatusCard
          ...
          badge={
            <Badge
              ...
              titleColor={theme.color.blueberry400}
              type="purple"
            />
          }
          progress={undefined}
...
ApplictionsInProgressScreen.options = getNavigationOptions
