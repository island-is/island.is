...
import { dynamicColor, EmptyList, FamilyMemberCard, Skeleton, TopLine } from "@ui";
...
export const FamilyOverviewScreen: NavigationFunctionComponent = ({ componentId }) => {
        ...
        return (
          <View style={{ marginTop: 80, paddingHorizontal: 16 }}>
            <EmptyList
              ...
              image={
                <Image source={illustrationSrc} style={{ width: 196, height: 261, resizeMode: 'contain' }} />
              }
            />
          </View>
        )
