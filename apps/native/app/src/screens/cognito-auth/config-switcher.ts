...
const identityServer = {
  ...
  scopes: 'openid profile offline_access @island.is/applications:read @island.is/documents @island.is/user-profile:read @island.is/internal @island.is/me:details',
};
