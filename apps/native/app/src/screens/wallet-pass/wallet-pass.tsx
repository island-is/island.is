...
export const WalletPassScreen: NavigationFunctionComponent<{ id: string }> = ({
  ...
  return (
    ...
    >
      <Container>
        <Heading>{res.data?.License?.title}</Heading>
    ...
    >
      <View style={{ flexDirection: 'row', width: '100%', paddingHorizontal: 32, paddingTop: 32, paddingBottom: 16 }}>
        <Text>Í gildi</Text>
        <View style={{ flex: 1 }} />
        <Text>14.2.2021 kl. 15:33</Text>
      </View>
      <View style={{ flexDirection: 'row', width: '100%', paddingHorizontal: 32 }}>
        <Text>kóði</Text>
        <View style={{ flex: 1 }} />
        <View style={{ borderColor: 'blue', borderWidth: 1, borderRadius: 4, padding: 4 }}><Text>Uppfæra</Text></View>
      </View>
      </SafeAreaView>
    </View>
  )
