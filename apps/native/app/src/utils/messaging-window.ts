// Ported from the my-pages health conversations messaging-window helper.
// Computes labels + "closing soon" state from the recipient's UTC window
// open/close times (HH:mm:ss).
