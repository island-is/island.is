...
import { ReactComponent as Svg } from '../../assets/icons/sidebar/mail.svg'
...
export default function Mail() {
  useEffect(() => {
    ...
    ;(function (s, i, o, w, d, a, b) {
      ...
      '91c80d77',
      {
        root: 'postholf-ms-svg',
        version: '2022-05-04',
        animations: [
          {
            elements: {
              'postholf-ms-svg-u-postholf': {
                transform: {
                  data: { t: { x: -16, y: -12.260543 } },
                  keys: {
                    o: [
                      {
                        t: 0,
                        v: { x: 16, y: 12.260543, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
                      },
                      {
                        t: 260,
                        v: { x: 16, y: 15.252989, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
                      },
                      {
                        t: 340,
                        v: { x: 16, y: 15.02697, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
                      },
                      { t: 600, v: { x: 16, y: 12.260543, type: 'corner' } },
                    ],
                    s: [
            ...
            s: '|',
          },
        ],
        options:
          'MDVAyMzkwMzc4OVDg5NzY4N0c4DOTM3NGYzNzcR4ODE3ZTc4ODVAzNzQxMzc3ORDgxN2VYNzg4JMDM3NGYzNzgH3N2E4OE44OVQk3Njg3ODkzNEzky',
      },
      '__SVGATOR_PLAYER__',
      window,
      document,
