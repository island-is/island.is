...
import { ReactComponent as Svg } from '../../assets/icons/sidebar/school.svg'
  ...
  useEffect(() => {
    ...
    ;(function (s, i, o, w, a, b) {
      ...
      '91c80d77',
      {
            ...
            elements: {
              eVQnqf4I9CK3: {
                transform: {
                  ...
                  keys: {
                    o: [
                      { t: 0, v: { x: 12, y: 9, type: 'corner' } },
                      {
                        t: 200,
                        v: { x: 11.985789, y: 9.709303, type: 'corner' },
                      },
                      { t: 400, v: { x: 12, y: 8, type: 'corner' } },
                      { t: 600, v: { x: 12, y: 9, type: 'corner' } },
                    ],
                  },
                },
              },
        ...
        options:
          'MDCAyMzlhNDE5MLjkzODA5MTkzVNDE1OTQxODJVQOGI4ODgyOGXFDNDE0YjQxOWDI4Yjg4ODI4JYTQxNTlWNDEE5MTg0OTI5M1II4MDkxSkM5MMzQxOWM/',
      },
      '__SVGATOR_PLAYER__',
      window,
    )
