...
@Injectable()
export class ApplicationAdminPaginatedSerializer
  implements NestInterceptor<ApplicationPaginatedResponse, Promise<unknown>>
{
  constructor(
  ...
  intercept(
    ...
    return next.handle().pipe(
      map(async (res: ApplicationPaginatedResponse) => {
        const applications = res.rows as Application[]
