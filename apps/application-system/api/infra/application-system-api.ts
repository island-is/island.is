...
export const workerSetup = (): ServiceBuilder<'application-system-api-worker'> =>
  service('application-system-api-worker')
    ...
    .secrets({
      ...
      DRIVING_LICENCE_BOOK_XROAD_PATH:
        '/k8s/application-system-api/DRIVING_LICENCE_BOOK_XROAD_PATH',
      DRIVING_LICENCE_BOOK_USERNAME:
        '/k8s/application-system-api/DRIVING_LICENCE_BOOK_USERNAME',
      DRIVING_LICENCE_BOOK_PASSWORD:
        '/k8s/application-system-api/DRIVING_LICENCE_BOOK_PASSWORD',
    })
