...
export const serviceSetup = (services: {
  ...
  service('application-system-api')
    ...
    .secrets({
      ...
      HH_ZENDESK_CONTACT_FORM_TOKEN:
        '/k8s/api/ZENDESK_HEILSUGAESLA_HOFUDBORGARSVAEDISINS_CONTACT_FORM_TOKEN',
      HH_ZENDESK_CONTACT_FORM_SUBDOMAIN:
        '/k8s/api/ZENDESK_HEILSUGAESLA_HOFUDBORGARSVAEDISINS_CONTACT_FORM_SUBDOMAIN',
    })
    .db()
    .migrations()
