import { getEnvVariables } from '@island.is/infra/dsl/service-to-environment/pre-process-service'
import { EnvironmentConfig } from '@island.is/infra/dsl/types/charts'
import { Base } from '@island.is/infra/dsl/xroad'
import { env } from '@island.is/testing/e2e'
import { resetMocks, wildcard } from '@island.is/testing/e2e'
