...
if (userMocked) {
  ...
  configure({
    ...
    scope: `openid profile api_resource.scope ${ApplicationScope.read} ${ApplicationScope.write} ${UserProfileScope.read} ${NationalRegistryScope.individuals} ${EndorsementsScope.actor}`,
