...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    var identityResources = queryInterface.bulkInsert(
      'identity_resource',
      [openId, profile, email],
      {},
    )

    var userClaims = queryInterface.bulkInsert(
      'identity_resource_user_claim',
      openIdClaims.concat(profileClaims, emailClaims),
      {},
    )
  ...
  down: (queryInterface, Sequelize) => {
    var userClaims = queryInterface.bulkDelete(
      'identity_resource_user_claim',
      null,
      {},
    )
    var identityResources = queryInterface.bulkDelete(
      'identity_resource',
      null,
      {},
    )
