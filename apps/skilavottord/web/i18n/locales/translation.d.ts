...
const typeMap: any = {
    "Translation": o([
        ...
        { json: "deregisterOverview", js: "deregisterOverview", typ: r("DeregisterOverview") },
        { json: "companyInfo", js: "companyInfo", typ: r("CompanyInfo") },
        { json: "companyInfoForm", js: "companyInfoForm", typ: r("CompanyInfoForm") },
        { json: "deregisterSidenav", js: "deregisterSidenav", typ: r("DeregisterSidenav") },
        { json: "deregisterVehicle", js: "deregisterVehicle", typ: r("TranslationDeregisterVehicle") },
        { json: "recyclingFundOverview", js: "recyclingFundOverview", typ: r("RecyclingFundOverview") },
        { json: "recyclingFundSidenav", js: "recyclingFundSidenav", typ: r("RecyclingFundSidenav") },
        { json: "recyclingCompanies", js: "recyclingCompanies", typ: r("RecyclingCompanies") },
    ...
    "AccessControl": o([
        ...
        { json: "tableHeaders", js: "tableHeaders", typ: r("AccessControlTableHeaders") },
    ...
    "ModalInputs": o([
        ...
        { json: "recyclingLocation", js: "recyclingLocation", typ: r("RecyclingLocation") },
    ...
    "Confirm": o([
        { json: "title", js: "title", typ: "" },
        { json: "subTitles", js: "subTitles", typ: u(undefined, r("ConfirmSubTitles")) },
        { json: "info", js: "info", typ: "" },
    ...
    "DeregisterOverview": o([
        { json: "title", js: "title", typ: "" },
        { json: "info", js: "info", typ: "" },
        { json: "subtitles", js: "subtitles", typ: r("DeregisterOverviewSubtitles") },
    ...
    "Footer": o([
        ...
        { json: "topLinksContact", js: "topLinksContact", typ: a(r("BottomLink")) },
    ...
    "Header": o([
        { json: "logoutText", js: "logoutText", typ: "" },
    ], false),
    "TranslationHome": o([
        { json: "title", js: "title", typ: "" },
    ], false),
    ...
    "RecyclingCompanies": o([
        ...
        { json: "info", js: "info", typ: "" },
        { json: "empty", js: "empty", typ: "" },
        { json: "subtitles", js: "subtitles", typ: r("RecyclingCompaniesSubtitles") },
        { json: "tableHeaders", js: "tableHeaders", typ: r("RecyclingCompaniesTableHeaders") },
        { json: "status", js: "status", typ: r("AccessControlStatus") },
        { json: "buttons", js: "buttons", typ: r("RecyclingCompaniesButtons") },
        { json: "recyclingCompany", js: "recyclingCompany", typ: r("RecyclingCompany") },
    ], false),
    ...
    "RecyclingFundOverview": o([
        { json: "title", js: "title", typ: "" },
        { json: "subtitles", js: "subtitles", typ: r("RecyclingFundOverviewSubtitles") },
        { json: "info", js: "info", typ: "" },
        { json: "buttons", js: "buttons", typ: r("RecyclingFundOverviewButtons") },
        { json: "search", js: "search", typ: r("Search") },
        { json: "table", js: "table", typ: a("") },
    ], false),
    ...
    "Routes": o([
        ...
        { json: "recycleVehicle", js: "recycleVehicle", typ: r("RecycleVehicle") },
        { json: "deregisterVehicle", js: "deregisterVehicle", typ: r("RoutesDeregisterVehicle") },
        { json: "recycledVehicles", js: "recycledVehicles", typ: "" },
        { json: "accessControl", js: "accessControl", typ: "" },
        { json: "accessControlCompany", js: "accessControlCompany", typ: "" },
        { json: "recyclingCompanies", js: "recyclingCompanies", typ: r("RecyclingCompaniesClass") },
        { json: "companyInfo", js: "companyInfo", typ: r("RecyclingCompaniesClass") },
    ], false),
