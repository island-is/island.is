...
export abstract class IQuery {
    ...
    abstract getNewsList(input: GetNewsListInput): PaginatedNews | Promise<PaginatedNews>;
    abstract getNamespace(input: GetNamespaceInput): Namespace | Promise<Namespace>;
    abstract getAboutPage(input: GetAboutPageInput): AboutPage | Promise<AboutPage>;
    abstract getLandingPage(input: GetLandingPageInput): LandingPage | Promise<LandingPage>;
    abstract getGenericPage(input: GetGenericPageInput): GenericPage | Promise<GenericPage>;
    abstract getAdgerdirPage(input: GetAdgerdirPageInput): AdgerdirPage | Promise<AdgerdirPage>;
    abstract getAdgerdirPages(input: GetAdgerdirPagesInput): AdgerdirPages | Promise<AdgerdirPages>;
    abstract getAdgerdirTags(input: GetAdgerdirTagsInput): AdgerdirTags | Promise<AdgerdirTags>;
    abstract getFrontpageSliderList(input: GetFrontpageSliderListInput): FrontpageSliderList | Promise<FrontpageSliderList>;
    abstract getAdgerdirFrontpage(input: GetAdgerdirFrontpageInput): AdgerdirFrontpage | Promise<AdgerdirFrontpage>;
    ...
    abstract searchResults(query: SearcherInput): SearchResult | Promise<SearchResult>;
    abstract singleItem(input: ItemInput): ContentItem | Promise<ContentItem>;
    abstract categories(input: CategoriesInput): ContentCategory[] | Promise<ContentCategory[]>;
    abstract articlesInCategory(category: ArticlesInCategoryInput): ContentItem[] | Promise<ContentItem[]>;
    abstract getApplication(input: GetApplicationInput): Application | Promise<Application>;
    abstract getApplicationsByType(input: GetApplicationsByTypeInput): Application[] | Promise<Application[]>;
...
export abstract class IMutation {
    ...
    abstract createApplication(input: CreateApplicationInput): Application | Promise<Application>;
    abstract updateApplication(input: UpdateApplicationInput): Application | Promise<Application>;
    abstract updateApplicationExternalData(input: UpdateApplicationExternalDataInput): Application | Promise<Application>;
    abstract addAttachment(input: AddAttachmentInput): Application | Promise<Application>;
    abstract deleteAttachment(input: DeleteAttachmentInput): Application | Promise<Application>;
    abstract createUploadUrl(filename: string): PresignedPost | Promise<PresignedPost>;
...
export type Slice = PageHeaderSlice | TimelineSlice | HeadingSlice | StorySlice | LinkCardSlice | LatestNewsSlice | MailingListSignupSlice | LogoListSlice | BulletListSlice;
