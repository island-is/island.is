...
@Injectable()
export class SamgongustofaRestService {
  constructor(
  ...
  async getUserVehiclesInformation(
    nationalId: string,
  ): Promise<VehicleRestInformation[]> {
    try {
      ...
      const vehicleInformationList: VehicleRestInformation[] = await parser
        ...
        .then(function (allCarsResult) {
          ...
          return parser
            ...
            .then(function (allCars) {
              ...
              const vehicleArr: VehicleRestInformation[] = []
              allCars['persidnolookup']['vehicleList'][0]['vehicle'].forEach(
                (car) => {
                  ...
                  const vehicleObj = new VehicleRestInformation(
                    car['permno'][0],
                    car['type'][0],
                    car['color'][0],
                    car['vin'][0],
