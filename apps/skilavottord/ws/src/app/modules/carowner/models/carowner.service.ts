...
export class CarownerService {
  ...
  constructor() {
    ...
    this.carList = []
    this.carList.push(
      new Car('Xll-732', 'Nissan', 'Leaf', 'blue', '2016', true),
    )
    this.carList.push(
      new Car('Dtx-429', 'Tesla', 'model-3', 'red', '2019', false),
    )
    this.carownerList.push(
    ...
    this.carList.push(
      new Car('Hjm-549', 'Suzuki', 'jimny', 'blue', '2009', true),
    )
    this.carownerList.push(
    ...
    this.carList.push(
      new Car('Ukb-141', 'Benz', 'G-63', 'black', '2016', false),
    )
    this.carownerList.push(
