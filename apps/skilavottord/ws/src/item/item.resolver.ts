...
export class ItemResolver {
  carsArray = [
    { owner: 'Runar', vehicleDesc: 'Volvo supercar', permNo: 'HXR-4532', outOfUse: 'No' },
    { owner: 'Tommi', vehicleDesc: 'Benz supercar', permNo: 'ABC-22234', outOfUse: 'No' },    
    { owner: 'Siggi', vehicleDesc: 'Kia supercar', permNo: 'ACC-25534', outOfUse: 'No' },
  ];
