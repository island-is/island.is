...
}): ServiceBuilder<'services-auth-identity-confirmation-api'> => {
  return service('services-auth-identity-confirmation-api')
    .namespace('identity-server-delegation')
    .image('services-auth-identity-confirmation-api')
    ...
    .ingress({
      internal: {
        host: {
          dev: 'auth-identity-confirmation-api',
          staging: 'auth-identity-confirmation-api',
          prod: 'auth-identity-confirmation-api.internal.innskra.island.is',
        },
        paths: ['/'],
        public: false,
      },
