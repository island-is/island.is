...
describe('withoutAuth and permissions', () => {
  it.each`
    method      | endpoint
    ${'GET'}    | ${`/v2/me/tenants/${encodeURIComponent(tenantId)}/clients/${encodeURIComponent(clientId)}/secrets`}
    ${'POST'}   | ${`/v2/me/tenants/${encodeURIComponent(tenantId)}/clients/${encodeURIComponent(clientId)}/secrets`}
    ${'DELETE'} | ${`/v2/me/tenants/${encodeURIComponent(tenantId)}/clients/${encodeURIComponent(clientId)}/secrets/someid`}
  `(
