...
describe('findByAuthEndorsement', () => {
  ...
  // it(`GET /endorsement-list/:listId/endorsement/exists should return 200 if no endorsement exists on list`, async () => {
  //   const app = await getAuthenticatedApp({
  //     nationalId: authNationalId,
  //     scope: [EndorsementsScope.main],
  //   })
  ...
  //   await expect(response.body.data.validate()).toMatchObject(false)
  // })
  ...
  //   const endorsement = new Endorsement(response.body.data) // we know we have at least one endorsement
