...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.addIndex('endorsement_list', ['endorsement_count', 'counter'], {
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.removeIndex('endorsement_list', 'idx_endorsement_count_counter');
