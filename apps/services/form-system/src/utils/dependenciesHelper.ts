...
export const filterDependency = (dependencies: Dependency[] | undefined, id: string): Dependency[] => {
...
export const filterArrayDependency = (dependencies: Dependency[] | undefined, ids: string[]): Dependency[] => {
  if (!dependencies) return []
