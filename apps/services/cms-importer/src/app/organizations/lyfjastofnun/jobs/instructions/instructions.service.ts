...
import { mapEntryCreationDto, mapSlug } from './instructions.mapper'
...
@Injectable()
export class LyfjastofnunInstructionsImportService {
  constructor(
  ...
  async run({
    ...
    await syncCreateOnly<LyfjastofnunScrapedItem, Link>({
      ...
      logLabel: 'Lyfjastofnun instructions import',
      publish,
      limit,
      getItems: () => this.lyfjastofnunRepository.getInstructions(),
      getExistingKeys: () =>
