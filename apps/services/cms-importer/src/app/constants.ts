export const SPACE_ID = '8k0h54kbe6bj'
export const ENVIRONMENT = 'master'
export const CONTENT_TYPE = 'grant'
export const LOCALE = 'is-IS'
export const EN_LOCALE = 'en'

export const PREVIOUS_RECIPIENTS_GENERIC_LIST_ID = '3Doc347oGYHXFOq4OcyKq7'
export const GENERIC_LIST_ITEM_CONTENT_TYPE = 'genericListItem'

export const UOS_TAGS: Record<string, string> = {
  Jarðhitaleit: '3B3enAALB55Yvh9mAL0keK',
  Kolefnisbinding: '5C5YPe2yn3jrUt57ess1j0',
  Orkunýtni: '4KRNqXqwd6q9MsULBFRIGU',
  ...
  Vindorka: '5oaXVYJeEWiRpvupMNK8OV',
