...
// Bank transfer refund types
export type BankTransferRefundSagaDefinition = SagaDefinition<
  BankTransferRefundContext,
  BankTransferRefundStepResults
>

export interface BankTransferRefundStepResults {
  VALIDATE_REFUND:
...
export interface BankTransferRefundContext
  extends PaymentContext<BankTransferRefundStepResults> {
  input: RefundPaymentInput
  paymentFulfillment: InferAttributes<PaymentFulfillment>
}
