  ...
  const pageContent: Page = {
    ...
    strings: [
      { id: 'dg-title', text: 'Þróunarhandbók' },
      {
        id: 'dg-intro',
        text:
          'Hér getur þú skoðað Þróunarhandbókina, sem er útgefin af Stafrænu Íslandi. Handbókin er hugsuð sem leiðarvísir um góð vinnubrögð við þróun vefþjónusta.',
      },
      {
        id: 'dg-body',
        text:
          'Þessi handbók á að hjálpa til við að samhæfa vinnu milli forritara og auðvelda samstarf. Farið er yfir viðeigandi hönnunarviðmið og mynstur sem nota skal svo notendaupplifunin sé ánægjuleg og sambærileg milli vefþjónusta.\n' +
          '\n' +
