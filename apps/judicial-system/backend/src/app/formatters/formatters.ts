...
export function formatProsecutorCourtDateEmailNotification(
  ...
  return `${court} hefur staðfest fyrirtökutíma fyrir ${scheduledCaseText}.<br /><br />Fyrirtaka mun fara fram ${courtDateText}.<br /><br />${courtRoomText}.<br /><br />${judgeText}.${registrarText}<br /><br />${defenderText}.`
}
