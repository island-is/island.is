...
export const notifications = {
  ...
  defenderResubmittedToCourt: defineMessages({
    ...
    link: {
      id: 'judicial.system.backend:notifications.defender_resubmitted_to_court.link',
      defaultMessage:
  ...
  signedRuling: defineMessages({
    ...
    defenderBody: {
      id: 'judicial.system.backend:notifications.signed_ruling.defender_body_v3',
      defaultMessage:
    ...
    prisonAdminBody: {
      id: 'judicial.system.backend:notifications.signed_ruling.prison_admin_body',
      defaultMessage:
  ...
  prisonRulingEmail: defineMessages({
    subject: {
      id: 'judicial.system.backend:notifications.prison_ruling_email.subject_v2',
      defaultMessage: 'Úrskurður í máli {courtCaseNumber}',
      description:
  ...
  rejectedCustodyEmail: defineMessages({
    subject: {
      id: 'judicial.system.backend:notifications.rejected_custody_email.subject_v2',
  ...
  defenderCourtDateEmail: defineMessages({
    ...
    link: {
      id: 'judicial.system.backend:notifications.defender_court_date_email.link',
      defaultMessage:
        '<br /><br />{defenderHasAccessToRvg, select, false {Þú getur nálgast gögn málsins hjá {courtName} ef þau hafa ekki þegar verið afhent} other {Þú getur nálgast gögn málsins í {linkStart}Réttarvörslugátt{linkEnd} með rafrænum skilríkjum}}.',
      description:
    ...
    linkNoRequestBody: {
      id: 'judicial.system.backend:notifications.defender_court_date_email.link_no_request_body',
      defaultMessage:
    ...
    linkNoRequest: {
      id: 'judicial.system.backend:notifications.defender_court_date_email.link_no_request',
      defaultMessage:
  ...
  defenderAssignedEmail: defineMessages({
    ...
    body: {
      id: 'judicial.system.backend:notifications.defender_assigned_email.body_v2',
      defaultMessage:
  ...
  caseAppealedToCourtOfAppeals: defineMessages({
    ...
    body: {
      id: 'judicial.system.backend:notifications.case_appealed_to_court_of_appeals.body_v2',
      defaultMessage:
  ...
  caseAppealReceivedByCourt: defineMessages({
    ...
    body: {
      id: 'judicial.system.backend:notifications.case_appeal_received_by_court.body_v2',
      defaultMessage:
    ...
    courtOfAppealsBody: {
      id: 'judicial.system.backend:notifications.case_appeal_received_by_court.court_of_appeals_body',
      defaultMessage:
