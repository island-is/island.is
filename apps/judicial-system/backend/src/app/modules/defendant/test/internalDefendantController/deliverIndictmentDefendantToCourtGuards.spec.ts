...
describe('InternalDefendantController - Deliver indictment defendant to court guards', () => {
  ...
  beforeEach(() => {
    guards = Reflect.getMetadata(
      '__guards__',
      InternalDefendantController.prototype.deliverIndictmentDefendantToCourt,
    )
  })
