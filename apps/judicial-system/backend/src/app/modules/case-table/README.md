...
- **CaseTableGroups**: Definitions of the different groups of case tables that exist in the application, based on user roles and contexts.
...
- `CaseTableGroups` should only define the groups of tables that exist in the application, based on user roles and contexts. It should not include any information about the columns or data fetching logic for those tables.
- Each case table type has a corresponding set of columns defined in `CaseTableTypes`. Only tables displaying cases should be defined as case table types; other types of tables (e.g. lists of users statistics) should be defined separately.
