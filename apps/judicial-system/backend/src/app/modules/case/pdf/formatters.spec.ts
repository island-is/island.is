...
describe('formatProsecutorDemands', () => {
  test('should format prosecutor demands with isolation', () => {
    ...
    // Assert
    expect(res).toBe(
      'Þess er krafist að Glanni Glæpur 010101-0000 verði með úrskurði Héraðsdóms Reykjavíkur gert að sæta gæsluvarðhaldi til 16. nóvember 2020 kl. 19:30 og verði gert að sæta einangrun meðan á gæsluvarðhaldi stendur.',
    )
  })
  ...
  test('should format prosecutor demands without isolation', () => {
    ...
    // Assert
    expect(res).toBe(
      'Þess er krafist að Glanni Glæpur 010101-0000 verði með úrskurði Héraðsdóms Reykjavíkur gert að sæta gæsluvarðhaldi til 16. nóvember 2020 kl. 19:30.',
    )
  })
})
