...
describe('InternalCaseController - Deliver court record working document to court guards', () => {
  ...
  beforeEach(() => {
    guards = Reflect.getMetadata(
      '__guards__',
      InternalCaseController.prototype.deliverCourtRecordWorkingDocumentToCourt,
    )
  })
