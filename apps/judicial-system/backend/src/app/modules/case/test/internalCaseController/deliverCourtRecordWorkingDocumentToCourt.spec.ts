...
describe('InternalCaseController - Deliver court record working document to court', () => {
  const userId = uuid()
  ...
  beforeEach(async () => {
    ...
    givenWhenThen = async (caseId: string, theCase: Case) => {
      ...
      await internalCaseController
        .deliverCourtRecordWorkingDocumentToCourt(caseId, theCase, { user })
  ...
  describe('court record working document delivered', () => {
    const caseId = uuid()
    const courtId = uuid()
    ...
    it('should create a working document at court', async () => {
