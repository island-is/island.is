...
describe('InternalSubpoenaController - Deliver service certificate to police guards', () => {
  ...
  beforeEach(() => {
    guards = Reflect.getMetadata(
      '__guards__',
      InternalSubpoenaController.prototype.deliverServiceCertificateToPolice,
    )
  })
