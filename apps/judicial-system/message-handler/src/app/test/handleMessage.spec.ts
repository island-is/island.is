...
describe('MessageHandlerService - Handle message', () => {
  ...
  describe('deliver prosecutor to court', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_PROSECUTOR_TO_COURT,
        user,
        caseId,
      })
    })
  ...
  describe('deliver defendant to court', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_DEFENDANT_TO_COURT,
        user,
        caseId,
        defendantId,
      } as DefendantMessage)
    ...
    it('should deliver defendant to court', async () => {
      expect(fetch).toHaveBeenCalledWith(
        `${config.backendUrl}/api/internal/case/${caseId}/deliverDefendantToCourt/${defendantId}`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('deliver case file to court', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_CASE_FILE_TO_COURT,
        user,
        caseId,
        caseFileId,
      } as CaseFileMessage)
    ...
    it('should deliver case file to court', async () => {
      expect(fetch).toHaveBeenCalledWith(
        `${config.backendUrl}/api/internal/case/${caseId}/deliverCaseFileToCourt/${caseFileId}`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('deliver case files record to court', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_CASE_FILES_RECORD_TO_COURT,
        user,
        caseId,
        policeCaseNumber,
  ...
  describe('deliver request to court', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_REQUEST_TO_COURT,
        user,
        caseId,
      })
    })
  ...
  describe('deliver court record to court', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_COURT_RECORD_TO_COURT,
        user,
        caseId,
      })
    })
  ...
  describe('deliver signed ruling to court', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_SIGNED_RULING_TO_COURT,
        user,
        caseId,
      })
    })
  ...
  describe('deliver case conclusion to court', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_CASE_CONCLUSION_TO_COURT,
        user,
        caseId,
      })
    })
  ...
  describe('deliver case to police', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_CASE_TO_POLICE,
        user,
        caseId,
      })
    })
  ...
  describe('deliver indictment case to police', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_INDICTMENT_CASE_TO_POLICE,
        user,
        caseId,
      })
    })

    it('should deliver indictment case to police', async () => {
      expect(fetch).toHaveBeenCalledWith(
        `${config.backendUrl}/api/internal/case/${caseId}/deliverIndictmentCaseToPolice`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('deliver indictment to police', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_INDICTMENT_TO_POLICE,
        user,
        caseId,
      })
    })
  ...
  describe('deliver case files record to police', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_CASE_FILES_RECORD_TO_POLICE,
        user,
        caseId,
        policeCaseNumber,
      } as PoliceCaseMessage)
  ...
  describe('deliver sigend ruling to police', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_SIGNED_RULING_TO_POLICE,
        user,
        caseId,
      })
    })
  ...
  describe('deliver appeal to police', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.DELIVER_APPEAL_TO_POLICE,
        user,
        caseId,
      })
    })
  ...
  describe('archive case file', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.ARCHIVE_CASE_FILE,
        user,
        caseId,
        caseFileId,
      } as CaseFileMessage)
    ...
    it('should archive case file', async () => {
      expect(fetch).toHaveBeenCalledWith(
        `${config.backendUrl}/api/internal/case/${caseId}/archiveCaseFile/${caseFileId}`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('archive case files record to court', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.ARCHIVE_CASE_FILES_RECORD,
        user,
        caseId,
        policeCaseNumber,
      } as PoliceCaseMessage)
  ...
  describe('send heads up notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_HEADS_UP_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send ready for court notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_READY_FOR_COURT_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send received by court notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_RECEIVED_BY_COURT_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send received by court notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_COURT_DATE_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send defendants not updated at court notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_DEFENDANTS_NOT_UPDATED_AT_COURT_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send ruling notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_RULING_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send modified notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_MODIFIED_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send revoked notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_REVOKED_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send defender assigned notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_DEFENDER_ASSIGNED_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send appeal to court of appeals notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_APPEAL_TO_COURT_OF_APPEALS_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send appeal received by court notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_APPEAL_RECEIVED_BY_COURT_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send appeal statement notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_APPEAL_STATEMENT_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send appeal completed notification', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_APPEAL_COMPLETED_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send judges assigned notification in appeal cases', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_APPEAL_JUDGES_ASSIGNED_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send appeal case files updated notifications in appeal cases', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_APPEAL_CASE_FILES_UPDATED_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send appeal withdrawn notification in appeal cases', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_APPEAL_WITHDRAWN_NOTIFICATION,
        user,
        caseId,
      })
    })
  ...
  describe('send indictment denied notifications', () => {
    ...
    beforeEach(async () => {
      then = await givenWhenThen({
        type: OldMessageType.SEND_INDICTMENT_DENIED_NOTIFICATION,
        user,
        caseId,
      })
    })
