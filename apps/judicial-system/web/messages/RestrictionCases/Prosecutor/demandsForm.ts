  ...
  sections: {
    demands: {
      ...
      prefill: defineMessages({
        searchWarrant: {
          id:
            'judicial.system.restriction_cases:police_demands.demands.prefill.search_warrant',
          defaultMessage:
        ...
        bankingSecrecyWaiver: {
          id:
            'judicial.system.restriction_cases:police_demands.demands.prefill.banking_secrecy_waiver',
          defaultMessage:
        ...
        phoneTapping: {
          id:
            'judicial.system.restriction_cases:police_demands.demands.prefill.phone_tapping',
          defaultMessage:
        ...
        teleCommunications: {
          id:
            'judicial.system.restriction_cases:police_demands.demands.prefill.tele_communications',
          defaultMessage:
        ...
        trackingEquipment: {
          id:
            'judicial.system.restriction_cases:police_demands.demands.prefill.tracking_equipment',
          defaultMessage:
    ...
    legalBasis: defineMessages({
      heading: {
        id:
          'judicial.system.restriction_cases:policeDemands.legal_basis.heading',
      ...
      label: {
        id: 'judicial.system.restriction_cases:policeDemands.legal_basis.label',
        defaultMessage: 'Lagaákvæði sem krafan er byggð á',
        description:
          'Notaður sem titill í "lagaákvæði sem krafan er byggð á" textaboxi á lagagrundvöllur og dómkröfur skrefi í gæsluvarðhalds- og farbannsmálum.',
      },
      placeholder: {
        id:
          'judicial.system.restriction_cases:policeDemands.legal_basis.placeholder',
