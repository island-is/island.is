  ...
  sections: {
    demands: {
      ...
      placeholder: defineMessage({
        id: 'judicial.system.restriction_cases:police_demands.demands.placeholder',
    ...
    custodyRestrictions: defineMessages({
      heading: {
        id: 'judicial.system.restriction_cases:police_demands.custody_restrictions.heading',
      ...
      subHeading: {
        id: 'judicial.system.restriction_cases:police_demands.custody_restrictions.sub_heading',
