...
export const rcReportForm = {
  ...
  courtClaim: defineMessages({
    heading: {
      id: 'judicial.system:restriction_cases.report_form.demand.heading',
    ...
    tooltip: {
      id: 'judicial.system:restriction_cases.report_form.demand.tooltip',
      defaultMessage:
    ...
    label: {
      id: 'judicial.system:restriction_cases.report_form.demand.label',
    ...
    placeholder: {
      id: 'judicial.system:restriction_cases.report_form.demand.placeholder',
      defaultMessage:
