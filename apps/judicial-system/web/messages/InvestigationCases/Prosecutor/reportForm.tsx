...
export const icReportForm = {
  ...
  caseFacts: defineMessages({
    ...
    placeholder: {
      id:
        'judicial.system.investigation_cases:report_form.case_facts.placeholder',
      defaultMessage:
  ...
  legalArguments: defineMessages({
    heading: {
      id:
        'judicial.system.investigation_cases:report_form.legal_arguments.heading',
    ...
    tooltip: {
      id:
        'judicial.system.investigation_cases:report_form.legal_arguments.tooltip',
      defaultMessage:
    ...
    label: {
      id:
        'judicial.system.investigation_cases:report_form.legal_arguments.label',
    ...
    placeholder: {
      id:
        'judicial.system.investigation_cases:report_form.legal_arguments.placeholder',
  ...
  comments: defineMessages({
    heading: {
      id: 'judicial.system.investigation_cases:report_form.comments.heading',
    ...
    tooltip: {
      id: 'judicial.system.investigation_cases:report_form.comments.tooltip',
      defaultMessage:
    ...
    label: {
      id: 'judicial.system.investigation_cases:report_form.comments.label',
    ...
    placeholder: {
      id:
        'judicial.system.investigation_cases:report_form.comments.placeholder',
      defaultMessage:
  ...
  prosecutorOnly: {
    checkbox: defineMessages({
      label: {
        id:
          'judicial.system.investigation_cases:report_form.prosecutor_only.checkbox.label',
      ...
      tooltip: {
        id:
          'judicial.system.investigation_cases:report_form.prosecutor_only.checkbox.tooltip',
        defaultMessage:
    ...
    input: defineMessages({
      label: {
        id:
          'judicial.system.investigation_cases:report_form.prosecutor_only.input.label',
      ...
      placeholder: {
        id:
          'judicial.system.investigation_cases:report_form.prosecutor_only.input.placeholder',
        defaultMessage:
      ...
      defaultValue: {
        id:
          'judicial.system.investigation_cases:report_form.prosecutor_only.input.default_value',
        defaultMessage:
