...
export const icOverview = {
  ...
  seenByDefenderAlert: defineMessages({
    title: {
      id: 'judicial.system.investigation_cases:overview.sections.seen_by_defender_alert.title',
    ...
    text: {
      id: 'judicial.system.investigation_cases:overview.sections.seen_by_defender_alert.text',
