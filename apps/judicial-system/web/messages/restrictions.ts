...
export const restrictions = defineMessages({
  [CaseCustodyRestrictions.ISOLATION]: {
    id: `judicial.system:laws[${CaseCustodyRestrictions.ISOLATION}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.VISITAION]: {
    id: `judicial.system:laws[${CaseCustodyRestrictions.VISITAION}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.COMMUNICATION]: {
    id: `judicial.system:laws[${CaseCustodyRestrictions.COMMUNICATION}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.MEDIA]: {
    id: `judicial.system:laws[${CaseCustodyRestrictions.MEDIA}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.ALTERNATIVE_TRAVEL_BAN_REQUIRE_NOTIFICATION]: {
    id: `judicial.system:laws[${CaseCustodyRestrictions.ALTERNATIVE_TRAVEL_BAN_REQUIRE_NOTIFICATION}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.ALTERNATIVE_TRAVEL_BAN_CONFISCATE_PASSPORT]: {
    id: `judicial.system:laws[${CaseCustodyRestrictions.ALTERNATIVE_TRAVEL_BAN_CONFISCATE_PASSPORT}]`,
    defaultMessage:
