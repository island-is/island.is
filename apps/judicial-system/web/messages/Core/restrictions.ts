...
export const restrictions = defineMessages({
  [CaseCustodyRestrictions.ISOLATION]: {
    id: `judicial.system.core:restrictions[${CaseCustodyRestrictions.ISOLATION}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.VISITAION]: {
    id: `judicial.system.core:restrictions[${CaseCustodyRestrictions.VISITAION}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.COMMUNICATION]: {
    id: `judicial.system.core:restrictions[${CaseCustodyRestrictions.COMMUNICATION}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.MEDIA]: {
    id: `judicial.system.core:restrictions[${CaseCustodyRestrictions.MEDIA}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.ALTERNATIVE_TRAVEL_BAN_REQUIRE_NOTIFICATION]: {
    id: `judicial.system.core:restrictions[${CaseCustodyRestrictions.ALTERNATIVE_TRAVEL_BAN_REQUIRE_NOTIFICATION}]`,
    defaultMessage:
  ...
  [CaseCustodyRestrictions.ALTERNATIVE_TRAVEL_BAN_CONFISCATE_PASSPORT]: {
    id: `judicial.system.core:restrictions[${CaseCustodyRestrictions.ALTERNATIVE_TRAVEL_BAN_CONFISCATE_PASSPORT}]`,
    defaultMessage:
