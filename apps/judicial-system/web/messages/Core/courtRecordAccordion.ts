  ...
  sections: {
    ...
    accusedRights: defineMessages({
      ...
      text: {
        ...
        defaultMessage:
          'Sakborning er bent á að honum sé óskylt að svara spurningum er varða brot það sem honum er gefið að sök, sbr. 2. mgr. 113. gr. laga nr. 88/2008. Sakborning er enn fremur áminntur um sannsögli kjósi hann að tjá sig um sakarefnið, sbr. 1. mgr. 114. gr. sömu laga.<br/><br/>Sakborningi er kynnt krafa á dómskjali nr. 1.',
        description:
