...
export const defenderCaseOverview = {
  title: defineMessages({
    investigationCaseRejected: defineMessage({
      id: 'judicial.system.core:defender_case_overview.title.investigation_case_rejected',
    ...
    restrictionCaseRejected: defineMessage({
      id: 'judicial.system.core:defender_case_overview.title.restriction_case_rejected',
    ...
    investigationCaseAccepted: defineMessage({
      id: 'judicial.system.core:defender_case_overview.title.investigation_case_accepted',
    ...
    restrictionCaseExpired: defineMessage({
      id: 'judicial.system.core:defender_case_overview.title.restriction_case_expired',
      defaultMessage:
    ...
    restrictionCaseActive: defineMessage({
      id: 'judicial.system.core:defender_case_overview.title.restriction_case_active',
      defaultMessage:
    ...
    restrictionCaseScheduled: defineMessage({
      id: 'judicial.system.core:defender_case_overview.title.restriction_case_scheduled',
      defaultMessage:
