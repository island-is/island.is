export const commentsInput = {
  heading: {
    ...
    description:
      'Notaður sem titill fyrir "athugasemdir vegna málsmeðferðar" hlutann í öllum málategundum',
  },
  tooltip: {
  ...
  label: {
    id: 'judicial.system.core:comments_input.label',
    defaultMessage: 'Athugasemdir',
    description:
      'Notaður sem titill í textaboxi fyrir "athugasemdir vegna málsmeðferðar" í öllum málategundum',
  },
  placeholder: {
    id: 'judicial.system.core:comments_input.placeholder',
    defaultMessage:
