...
type stepValidationsType = {
  ...
  [constants.INVESTIGATION_CASE_CASE_FILES_ROUTE]: (theCase: Case) => boolean
  [constants.INDICTMENTS_DEFENDANT_ROUTE]: (theCase: Case) => boolean
  [constants.INDICTMENTS_POLICE_CASE_FILES_ROUTE]: (theCase: Case) => boolean
  [constants.INDICTMENTS_CASE_FILE_ROUTE]: (theCase: Case) => boolean
  ...
  [constants.RESTRICTION_CASE_COURT_OVERVIEW_ROUTE]: (theCase: Case) => boolean
  ...
  [constants.INVESTIGATION_CASE_OVERVIEW_ROUTE]: (theCase: Case) => boolean
  ...
  [constants.INDICTMENTS_OVERVIEW_ROUTE]: (theCase: Case) => boolean
  [constants.INDICTMENTS_RECEPTION_AND_ASSIGNMENT_ROUTE]: (
    theCase: Case,
  ) => boolean
