...
export const strings = defineMessages({
  title: {
    id: 'judicial.system.core:cases_awaiting_review.title',
    defaultMessage: 'Þín mál til yfirlestrar',
    description: 'Titill á þínum málum sem eru til yfirlestrar hjá þér',
  },
  infoContainerTitle: {
    id: 'judicial.system.core:cases_awaiting_review.info_container_title',
  ...
  infoContainerMessage: {
    id: 'judicial.system.core:cases_awaiting_review.info_container_message',
