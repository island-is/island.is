...
export const strings = defineMessages({
  title: {
    id: 'judicial.system.core:cases_for_review.title',
    defaultMessage: 'Mál til yfirlestrar',
    description: 'Titill á málum sem eru til yfirlestrar',
  },
  infoContainerTitle: {
    id: 'judicial.system.core:cases_for_review.info_container_title',
  ...
  infoContainerMessage: {
    id: 'judicial.system.core:cases_for_review.info_container_message',
