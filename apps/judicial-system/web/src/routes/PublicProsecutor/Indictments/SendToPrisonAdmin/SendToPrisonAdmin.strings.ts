...
export const strings = defineMessages({
  ...
  nextButtonText: {
    id: 'judicial.system.core:send_to_prison_admin.next_button_text',
    defaultMessage: 'Senda til fullnustu',
    description: 'Notaður sem texti í áfram takka.',
  },
  modalTitle: {
    id: 'judicial.system.core:send_to_prison_admin.modal_title',
    defaultMessage: 'Senda til fullnustu',
    description:
  ...
  modalNextButtonText: {
    id: 'judicial.system.core:send_to_prison_admin.modal_next_button_text',
