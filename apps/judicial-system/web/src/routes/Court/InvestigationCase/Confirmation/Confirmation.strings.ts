...
export const confirmation = defineMessages({
  ...
  conclusionTitle: {
    id: 'judicial.system.core:confirmation.conclusion_title',
  ...
  continueButtonTextAccepting: {
    id: 'judicial.system.core:confirmation.continue_button_text_accepting',
  ...
  continueButtonTextAcceptingPartially: {
    id:
      'judicial.system.core:confirmation.continue_button_text_accepting_partially',
  ...
  continueButtonTextRejecting: {
    id: 'judicial.system.core:confirmation.continue_button_text_rejecting',
  ...
  continueButtonTextDismissing: {
    id: 'judicial.system.core:confirmation.continue_button_text_dismissing',
