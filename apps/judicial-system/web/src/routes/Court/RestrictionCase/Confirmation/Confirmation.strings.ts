...
export const confirmation = defineMessages({
  ...
  continueButtonTextAccepting: {
    id:
      'judicial.system.core:restriction_case_confirmation.continue_button_text_accepting',
  ...
  continueButtonTextAcceptingPartially: {
    id:
      'judicial.system.core:restriction_case_confirmation.continue_button_text_accepting_partially',
  ...
  continueButtonTextRejecting: {
    id:
      'judicial.system.core:restriction_case_confirmation.continue_button_text_rejecting',
  ...
  continueButtonTextDismissing: {
    id:
      'judicial.system.core:restriction_case_confirmation.continue_button_text_dismissing',
  ...
  continueButtonTextAcceptingAlternativeTravelBan: {
    id:
      'judicial.system.core:restriction_case_confirmation.continue_button_text_accepting_alternative_travel_ban',
