...
export const strings = defineMessages({
  ...
  confirmStatementAfterDeadlineModalText: {
    id: 'judicial.system.core:signed_verdict_overview.confirm_statement_after_deadline_modal_text',
  ...
  confirmStatementAfterDeadlineModalPrimaryButtonText: {
    id: 'judicial.system.core:signed_verdict_overview.confirm_statement_after_deadline_modal_primary_button_text',
  ...
  confirmStatementAfterDeadlineModalSecondaryButtonText: {
    id: 'judicial.system.core:signed_verdict_overview.confirm_statement_after_deadline_modal_secondary_button_text',
