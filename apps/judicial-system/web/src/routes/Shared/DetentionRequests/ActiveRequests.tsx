...
import { Button, Text, Tag, Box, Icon } from '@island.is/island-ui/core'
...
const ActiveRequests: React.FC<DetentionRequestTableProps> = (props) => {
  const {
    requestSort,
    getClassNamesFor,
    isProsecutor,
