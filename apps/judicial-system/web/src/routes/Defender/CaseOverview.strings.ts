...
export const strings = defineMessages({
  investigationCaseRejectedTitle: {
    id: 'judicial.system.core:defender_case_overview.investigation_case_rejected_title',
  ...
  restrictionCaseRejectedTitle: {
    id: 'judicial.system.core:defender_case_overview.restriction_case_rejected_title',
  ...
  investigationCaseAcceptedTitle: {
    id: 'judicial.system.core:defender_case_overview.investigation_case_accepted_title',
  ...
  restrictionCaseExpiredTitle: {
    id: 'judicial.system.core:defender_case_overview.restriction_case_expired_title',
    defaultMessage:
  ...
  restrictionCaseActiveTitle: {
    id: 'judicial.system.core:defender_case_overview.restriction_case_active_title',
    defaultMessage:
  ...
  restrictionCaseScheduledTitle: {
    id: 'judicial.system.core:defender_case_overview.restriction_case_scheduled_title',
    defaultMessage:
