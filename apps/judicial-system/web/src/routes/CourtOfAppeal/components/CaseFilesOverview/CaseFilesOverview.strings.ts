...
export const strings = defineMessages({
  courtCaseFilesTitle: {
    id:
      'judicial.system.core:court_of_appeal.case_files_overview.court_case_files_title',
  ...
  unsignedDocument: {
    id:
      'judicial.system.core:court_of_appeal.case_files_overview.unsigned_document',
