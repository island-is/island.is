...
export const PoliceCaseInfo = forwardRef<HTMLDivElement, Props>(
  (
    {
      index,
      policeCaseNumbers,
        ...
        <BlueBox>
          ...
          <Box marginBottom={2}>
            <Select
              ...
              placeholder={formatMessage(
                policeCaseInfo.indictmentTypePlaceholder,
              )}
          ...
          <Box marginBottom={2}>
            <Input
              ...
              placeholder={formatMessage(
                policeCaseInfo.policeCasePlacePlaceholder,
              )}
