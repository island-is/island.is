...
export const indictmentCountEnum = defineMessages({
  DRIVING_WITHOUT_LICENCE: {
    id:
      'judicial.system.core:indictments_indictment.indictment_count_enum.suspended_drivers_licence_v2',
    defaultMessage: 'Sviptingarakstur',
    description: 'Notaður sem titill á subtype fyrir "sviptingarakstur" brot.',
  },
  DRUNK_DRIVING: {
    id:
      'judicial.system.core:indictments_indictment.indictment_count_enum.drunk_driving_v2',
