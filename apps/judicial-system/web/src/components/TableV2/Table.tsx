...
import { displayCaseType } from '../../routes/Shared/Cases/utils'
...
const TableV: React.FC<Props> = (props) => {
  const { data, onRowClick, isCompletedCases } = props
        ...
        <tr>
          ...
          <th className={styles.th}>
            {isCompletedCases ? (
              ...
              >
                <Text fontWeight="regular">Gildistími</Text>
                <Box
                  className={cn(styles.sortIcon, {
