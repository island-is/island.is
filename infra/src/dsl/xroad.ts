...
export const DrivingLicenseBook = new XroadConf({
  env: {},
  secrets: {
    DRIVING_LICENCE_BOOK_XROAD_PATH: '/k8s/api/DRIVING_LICENCE_BOOK_XROAD_PATH',
    DRIVING_LICENCE_BOOK_USERNAME: '/k8s/api/DRIVING_LICENCE_BOOK_USERNAME',
    DRIVING_LICENCE_BOOK_PASSWORD: '/k8s/api/DRIVING_LICENCE_BOOK_PASSWORD',
  },
})
