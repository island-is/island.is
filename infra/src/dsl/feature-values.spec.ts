...
describe('Feature-deployment support', () => {
  ...
  it('bff feature env urls', () => {
    expect(values.services['services-bff-portals-admin'].env).toEqual({
      ...
      BFF_ALLOWED_REDIRECT_URIS: json(['https://feature-A.dev01.devland.is']),
      BFF_CLIENT_BASE_URL: 'https://feature-A.dev01.devland.is',
      BFF_LOGOUT_REDIRECT_URI: 'https://feature-A.dev01.devland.is',
      BFF_CALLBACKS_BASE_PATH: `https://feature-A.dev01.devland.is/stjornbord/bff/callbacks`,
