...
import { serviceSetup as universityGatewaySetup } from '../../../apps/services/university-gateway/infra/university-gateway'
...
const universityGateway = universityGatewaySetup()
