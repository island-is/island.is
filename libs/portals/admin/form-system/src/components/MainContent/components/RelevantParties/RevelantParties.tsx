...
export const RelevantParties = () => {
  ...
  //     Boolean,
  //   ) as FormSystemFormApplicant[],
  // )
  // const [focus, setOnFocus] = useState('')

  // const createFormApplicantType = (
  //   type: string,
  //   template: FormSystemFormApplicantType,
  // ): FormSystemFormApplicant => {
  //   return {
  ...
  // const isOther = (applicant: FormSystemFormApplicant) => {
  ...
  //     newFormApplicantTypes: FormSystemFormApplicant[],
  //   ) => {
  ...
  //         const newFormApplicantType: FormSystemFormApplicant =
  ...
  //         return
  //       }
  //       const newFormApplicantTypes: FormSystemFormApplicant[] = [
  ...
  //   </Stack>
  // )
  return <div>RelevantParties</div>
}
