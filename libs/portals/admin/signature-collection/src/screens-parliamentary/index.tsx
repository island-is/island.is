  ...
  return (
    <GridContainer>
      <GridRow direction="row">
        ...
        >
          <ScreenHeader
            electionName={formatMessage(m.parliamentaryCollectionTitle)}
                  ...
                  (data?.signatureCollectionSignatureLookup.length > 0 ? (
                    <Box marginBottom={6}>
                      <T.Table>
                        ...
                        <T.Body>
                          {data?.signatureCollectionSignatureLookup?.map(
                            (s) => (
                              <T.Row key={s.id}>
                                <T.Data
                                  span={3}
                                  text={{ variant: 'medium' }}
                                  box={{
                                    background: s.valid ? 'white' : 'red100',
                                  }}
                                >
                                  {s.signee.name}
                                </T.Data>
                ...
                {allowedToProcess && (
                  <Box>
                    ...
                    {(collectionStatus === CollectionStatus.InitialActive ||
                      collectionStatus ===
                        CollectionStatus.InInitialReview) && (
