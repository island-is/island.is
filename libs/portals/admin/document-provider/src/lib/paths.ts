export enum DocumentProviderPaths {
  ...
  InstitutionDocumentProviderOverview = 'skjalaveitur/stofnun/yfirlit',
  InstitutionDocumentProviderDocumentProvidersSingle = 'skjalaveitur/stofnun/yfirlit/:providerId',
