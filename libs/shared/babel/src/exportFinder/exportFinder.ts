...
const findExportedNames = (declaration: Declaration) => {
  const names = []
...
type ExportMap = { [key: string]: string }
type FileCache = { [modulePath: string]: ExportDefinition[] }

const visitModule = (
  modulePath: string,
  findName: string | null = null,
...
const exportFinder = (mainPath: string) => {
