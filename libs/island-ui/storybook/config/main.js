...
module.exports = {
  ...
  stories: ['../../core/src/**/*.stories.@(tsx|mdx)', '../../../application/ui-fields/src/lib/AsGuide.stories.mdx', '../../../application/ui-fields/**/*.stories.@(tsx|mdx)', '../../../application/ui-components/**/*.stories.@(tsx|mdx)'],
  addons: ['@storybook/addon-a11y', '@storybook/addon-essentials', 'storybook-addon-designs', 'storybook-addon-apollo-client', '@storybook/addon-mdx-gfm'],
  babel: async options => ({
    ...options,
  ...
  webpackFinal: config => {
    ...
    config.resolve = {
      ...
      alias: {
        ...
        '@island.is/application/types': rootDir('../../../application/types/src'),
        '@island.is/application/graphql': rootDir('../../../application/graphql/src'),
        '@island.is/application/ui-components': rootDir('../../../application/ui-components/src'),
        '@island.is/auth/react': rootDir('../../../auth/react/src'),
        '@island.is/shared/constants': rootDir('../../../shared/constants/src'),
        '@island.is/shared/form-fields': rootDir('../../../shared/form-fields/src'),
        '@island.is/shared/problem': rootDir('../../../shared/problem/src'),
        '@island.is/shared/utils': rootDir('../../../shared/utils/src'),
        '@island.is/shared/translations': rootDir('../../../shared/translations/src'),
        '@island.is/shared/types': rootDir('../../../shared/types/src'),
        '@island.is/shared/components': rootDir('../../../shared/components/src'),
        '@island.is/localization': rootDir('../../../localization/src'),
        '@island.is/react/components': rootDir('../../../react/components/src'),
        '@island.is/react/feature-flags': rootDir('../../../react/feature-flags/src'),
