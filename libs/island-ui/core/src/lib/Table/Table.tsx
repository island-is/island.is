...
export const Head: FC<React.PropsWithChildren<HeadProps>> = ({ children, sticky }) => (
  <thead
    {...(sticky && {
...
export const Body: FC<React.PropsWithChildren<unknown>> = ({ children }) => <tbody>{children}</tbody>

export const Foot: FC<React.PropsWithChildren<unknown>> = ({ children }) => <tfoot>{children}</tfoot>

export const Row: FC<React.PropsWithChildren<TestSupport>> = ({ children, dataTestId }) => (
