...
// Keyed by the raw AsyncSearchSizes rather than the normalized size, so the
// divider can track the input height: medium is 40/48, semi-large 56/64 and
// large 72/80. The horizontal offsets follow the search icon, which does
// normalize semi-large to medium.
