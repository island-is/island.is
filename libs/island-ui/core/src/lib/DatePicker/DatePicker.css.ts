...
globalStyle(
  `${root}.island-ui-datepicker.${medium} .react-datepicker-popper[data-placement^="top"] .react-datepicker`,
  {
    top: '6px',
  },
)
...
globalStyle(
  `${root}.island-ui-datepicker.${detached}.${extraSmall} .react-datepicker-popper[data-placement^="top"] .react-datepicker`,
  {
    top: '23px',
  },
)
