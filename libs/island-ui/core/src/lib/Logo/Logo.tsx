  ...
  (
    ...
    iconOnly ? (
      ...
      >
        ...
        <path
          fill={solidColor || `url(#paint0_linear_${id})`}
        ...
        <g>
          <g>
            <rect
              ...
              height="65.94"
              rx="2.15"
              fill={solidColor ? 'currentColor' : undefined}
            />
            <rect
              x="271.14"
              y="9.6"
            ...
            <circle
              ...
              fill={solidColor ? 'currentColor' : '#ff0050'}
            />
            <circle
              cx="177.9"
              cy="12.76"
