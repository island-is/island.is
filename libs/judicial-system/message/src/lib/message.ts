...
export enum MessageType {
  ...
  DELIVERY_TO_COURT_REQUEST_DEFENDER_INFO = 'DELIVERY_TO_COURT_REQUEST_DEFENDER_INFO',
...
export const messageEndpoint: { [key in MessageType]: string } = {
  ...
  DELIVERY_TO_COURT_REQUEST_DEFENDER_INFO: 'deliverRequestDefenderInfoToCourt',
