...
export enum MessageType {
  ...
  DELIVERY_TO_POLICE_VERDICT_SERVICE_CERTIFICATE = 'DELIVERY_TO_POLICE_VERDICT_SERVICE_CERTIFICATE',
...
export const messageEndpoint: { [key in MessageType]: string } = {
  ...
  DELIVERY_TO_POLICE_VERDICT_SERVICE_CERTIFICATE:
    'deliverVerdictServiceCertificateToPolice',
  NOTIFICATION: 'notification',
