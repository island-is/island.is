...
export enum AuditedAction {
  ...
  CREATE_APPEAL_CASE = 'CREATE_APPEAL_CASE',
  UPDATE_APPEAL_CASE = 'UPDATE_APPEAL_CASE',
  TRANSITION_APPEAL_CASE = 'TRANSITION_APPEAL_CASE',
  ...
  DUPLICATE_INDICTMENT_CASE = 'DUPLICATE_INDICTMENT_CASE',
  GET_USERS = 'GET_USERS',
  GET_USER = 'GET_USER',
  ...
  CONFIRM_RULING_ORDER = 'CONFIRM_RULING_ORDER',
  ATTACH_RULING_ORDER_DOCUMENT = 'ATTACH_RULING_ORDER_DOCUMENT',
  ...
  GET_POLICE_DEFENDANTS = 'GET_POLICE_DEFENDANTS',
  GET_POLICE_DIGITAL_CASE_FILES = 'GET_POLICE_DIGITAL_CASE_FILES',
  GET_POLICE_CASE_INFO = 'GET_POLICE_CASE_INFO',
  GET_POLICE_CASE_UNITS = 'GET_POLICE_CASE_UNITS',
  UPLOAD_POLICE_CASE_FILE = 'UPLOAD_POLICE_CASE_FILE',
  GET_POLICE_DIGITAL_CASE_FILE_TOKEN_URL = 'GET_POLICE_DIGITAL_CASE_FILE_TOKEN_URL',
  DELETE_POLICE_DIGITAL_CASE_FILE = 'DELETE_POLICE_DIGITAL_CASE_FILE',
  UPDATE_POLICE_DIGITAL_CASE_FILES = 'UPDATE_POLICE_DIGITAL_CASE_FILES',
  ...
  PRONOUNCE_RULING_ORALLY = 'PRONOUNCE_RULING_ORALLY',
  UPDATE_SUBPOENA = 'UPDATE_SUBPOENA',
  GET_SUBPOENA = 'GET_SUBPOENA',
  CREATE_SUBPOENAS = 'CREATE_SUBPOENAS',
  ...
  GET_MESSAGE_SUSPENSIONS = 'GET_MESSAGE_SUSPENSIONS',
  UPDATE_MESSAGE_SUSPENSION = 'UPDATE_MESSAGE_SUSPENSION',
}
