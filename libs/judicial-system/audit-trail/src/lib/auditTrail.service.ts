...
export enum AuditedAction {
  ...
  CREATE_COURT_SESSION_DOCUMENT = 'CREATE_COURT_SESSION_DOCUMENT',
  UPDATE_COURT_SESSION_DOCUMENT = 'UPDATE_COURT_SESSION_DOCUMENT',
  DELETE_COURT_SESSION_DOCUMENT = 'DELETE_COURT_SESSION_DOCUMENT',
}
