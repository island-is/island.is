...
export enum NotificationType {
  ...
  INDICTMENT_SPLIT_COMPLETED = IndictmentCaseNotificationType.INDICTMENT_SPLIT_COMPLETED,
  ...
  PUBLIC_PROSECUTOR_REVIEWER_ASSIGNED = CaseNotificationType.PUBLIC_PROSECUTOR_REVIEWER_ASSIGNED,
  ...
  INDICTMENT_REOPENED = CaseNotificationType.INDICTMENT_REOPENED,
}
