...
export const LegalGazetteClientProvider: Provider<LegalGazetteApi> = {
  provide: LegalGazetteApi,
  useFactory: (
  ...
  inject: [XRoadConfig.KEY, LegalGazetteClientConfig.KEY, IdsClientConfig.KEY],
}
