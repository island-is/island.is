...
>({
  ...
  load: (env) => ({
    ...
    scopeAdmin: [NationalRegistryScope.signatureCollection, NationalRegistryScope.signatureCollectionProcess],
    scopeManager: [ NationalRegistryScope.signatureCollection, NationalRegistryScope.signatureCollectionProcess],
