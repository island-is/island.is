import { TrWebCommonsExternalPortalsApiModelsPaymentPlanPaymentPlanDto } from '../../gen/fetch'

export const MOCK_DATA: TrWebCommonsExternalPortalsApiModelsPaymentPlanPaymentPlanDto =
  {
    paymentPlan: {
      groups: [
        {
