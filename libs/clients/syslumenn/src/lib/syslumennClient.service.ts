...
import { UpplysingarUrDanarbuiRadstofunSkeyti } from 'libs/clients/district-commissioners-licenses/gen/fetch/models/UpplysingarUrDanarbuiRadstofunSkeyti'
...
export class SyslumennService {
  ...
  async getEstateInfo(nationalId: string): Promise<EstateInfo[]> {
    ...
    console.log('getEstateInfo res', JSON.stringify(res, null, 2))
  ...
  async getEstateInfoWithAvailableSettlements(
    ...
    // console.log(
    //   'getEstateInfoWithAvailableSettlements res',
    //   JSON.stringify(res, null, 2),
    // )

    const res: UpplysingarUrDanarbuiRadstofunSkeyti = {
      audkenni: 'f5b73bfe-395e-4e41-9d85-dfd9cbcfba8a',
      yfirlit: [
        {
          malsnumer: '2022046089',
          kennitala: '0101302399',
          nafn: 'Gervimaður Færeyjar',
          danardagur: new Date('2022-07-03T00:00:00.000Z'),
          logheimili: 'Færeyjar,  ',
          erfingar: [
            {
              kennitala: '1109817169',
              nafn: 'Páll Grétar Jónsson',
              heimilisfang: 'Þrastarás 26',
              simi: '+3547807924',
              netfang: 'palli@t1.is',
            },
            {
              kennitala: '1109817169',
              nafn: 'Kristján Albert Loftsson',
              heimilisfang: 'Barmahlíð 45',
              tengsl: 'Barn',
              simi: '8439792',
              netfang: 'stjanilofts@gmail.com',
            },
          ],
          kaupmali: false,
          erfdakraVitneskja: false,
          eignir: [
            {
              tegundAngalgs: 0,
              fastanumer: '2220000',
              lysing: 'Suðurás 30, Reykjavík, fnr. 222-0000',
              eignarhlutfall: 100,
              verdmaeti: '30000000',
            },
            {
              tegundAngalgs: 0,
              fastanumer: '2223000',
              lysing: 'Jaðarstún 10, Akureyri, fnr. 222300',
              eignarhlutfall: 100,
              verdmaeti: '25000000',
            },
            {
            ...
            },
            {
              tegundAngalgs: 1,
              fastanumer: 'vkh93',
              lysing: 'VK-H93, VOLVO S60 x',
              eignarhlutfall: 0,
              verdmaeti: '3000000',
            },
            {
              tegundAngalgs: 10,
              fastanumer: '000-000-0000',
              lysing: 'Gun',
              eignarhlutfall: 0,
              verdmaeti: '30000',
            },
            ...
            {
              tegundAngalgs: 7,
              fastanumer: '6808140150',
              lysing: 'Sýslumaður ehf.',
              eignarhlutfall: 0,
              upphaed: '1000000',
              gengiVextir: '1,53',
            },
            ...
            {
              tegundAngalgs: 20,
              fastanumer: '0000-3000-4000-5000',
              lysing: 'Visa',
              eignarhlutfall: 0,
              verdmaeti: '500000',
            },
            {
              tegundAngalgs: 20,
              fastanumer: '1111-2222-3333-4444',
              lysing: 'Euro',
              eignarhlutfall: 0,
              verdmaeti: '1000000',
            },
            ...
            },
            {
              tegundAngalgs: 1,
              fastanumer: 'TL423',
              lysing: 'TL-423, PORSCHE 987',
              eignarhlutfall: 0,
              verdmaeti: '5000000',
            },
          ],
          mogulegSkipti: {
            EignalaustDanarbu: 'Í lagi',
            Einkaskipti: 'Í lagi',
            SetaiOskiptuBui: 'Í lagi',
            OpinberSkipti: 'Í lagi',
          },
        },
      ],
      texti: '',
