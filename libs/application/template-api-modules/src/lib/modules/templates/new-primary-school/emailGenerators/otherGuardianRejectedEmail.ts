...
export const generateOtherGuardianRejectedApplicationEmail: EmailTemplateGenerator =
  (props): Message => {
    const {
      application,
    ...
    const subject = 'Samþykki fyrir umsókn í grunnskóla hafnað'
      ...
      template: {
        ...
        body: [
          ...
          { component: 'Copy', context: { copy: 'Góðan dag,' } },
          {
            component: 'Copy',
            context: {
              copy: 'Forsjáraðili hefur hafnað því að samþykkja umsókn þína í grunnskóla fyrir eftirfarandi barn:',
            },
          },
          {
            component: 'Copy',
          ...
          },
          {
            component: 'Copy',
            context: {
              copy: `Þú þarft því að draga umsóknina til baka, eða senda hana á ný til samþykktar hjá forsjáraðila`,
            },
          },
          {
            component: 'Button',
