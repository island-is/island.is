...
const recipientEmailAddress = process.env.INSTITUTION_APPLICATION_RECIPIENT_EMAIL_ADDRESS ?? 'development@island.is'
const senderEmailAddress = process.env.INSTITUTION_APPLICATION_SENDER_EMAIL_ADDRESS ?? 'development@island.is'
