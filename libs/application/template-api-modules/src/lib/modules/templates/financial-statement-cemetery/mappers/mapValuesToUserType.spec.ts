import { ClientRoles, Contact, ContactType } from '@island.is/clients/financial-statements-inao'
...
describe('mapValuesToUserType', () => {
    ...
    describe('mapContactsAnswersToContacts', () => {
        it('should map correctly', () => {
            ...
            const result = mapper.mapContactsAnswersToContacts(actor, actorsName, contactsAnswer)

            expect(result).toEqual(expectedResult)
            expect(result).toBeInstanceOf(Array<Contact>)
        })
    })
