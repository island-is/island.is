...
export const mockGetProperties = (): Array<Fasteign> => {
  return [
    getMockedFasteign('Vesturhóp 34, 240 Grindavík', '2212345', [
      {
    ...
    getMockedFasteign('Mosarimi 2, 112 Reykjavík', '2254321', [
      {
        notkunBirting: 'Íbúðarhúsalóð',
    ...
    getMockedFasteign('Dúfnahólar 10, 105 Reykjavík', '2298765', [
      {
        notkunBirting: 'Íbúðarhúsalóð',
