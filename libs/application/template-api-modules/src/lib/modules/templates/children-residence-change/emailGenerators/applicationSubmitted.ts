...
export const generateApplicationSubmittedEmail: ApplicationSubmittedEmail = (
  ...
  const fontStyles = 'font-size: 16px; line-height:22px;'
  const fileName =
