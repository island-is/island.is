...
export const generateRequestReviewEmail: RequestReviewEmail = (
  ...
  const subject = 'Tilkynning um breytingu á meðeigendum - Vantar samþykki'
        ...
        },
        {
          ...
          context: {
            copy:
              ...
              `<span>Þín bíður ósamþykkt beiðni um breytingu á meðeigendum fyrir ökutækið ${permno} á island.is.</span><br/>` +
