...
import { ComplaintsToAlthingiOmbudsmanModule } from './complaints-to-althingi-ombudsman/complaints-to-althingi-ombudsman.module'
...
export const modules = [
  ...
  ComplaintsToAlthingiOmbudsmanModule,
]
...
export { ComplaintsToAlthingiOmbudsmanService } from './complaints-to-althingi-ombudsman/complaints-to-althingi-ombudsman.service'
