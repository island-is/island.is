    ...
    template: {
      ...
      body: [
        ...
        },
        {
          component: 'Copy',
          context: {
            copy: `Ef þú áttir von á þessum tölvupósti smellir þú á takkann hér fyrir neðan. Ef annar einstaklingur á að samþykkja fæðingarorlofið má áframsenda póstinn á viðkomandi einstakling (passið þó að opna ekki linkinn).`,
          },
        },
        {
          component: 'Button',
