...
import * as CompanySearchFormFieldStories from './CompanySearchFormField.stories'
...
<Meta of={CompanySearchFormFieldStories} />
...
<Canvas>
  <Story of={CompanySearchFormFieldStories.Default} />
</Canvas>
