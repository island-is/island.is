export enum ApplicationTypes {
  ...
  DIRECTORATE_OF_HEALTH_WORK_LICENSE = 'DirectorateOfHealthWorkLicense',
}
...
export const ApplicationConfigurations = {
  ...
  [ApplicationTypes.DIRECTORATE_OF_HEALTH_WORK_LICENSE]: {
    slug: 'vottord-vegna-starfsleyfis',
    translation: 'dh.wh.application',
  },
}
