...
export const review = {
  ...
  step: {
    tagText: defineMessages({
      received: {
        id: 'aosh.drm.application:review.step.tagText.received',
        defaultMessage: 'Móttekin',
        description: 'Received tag text in status step part of review process',
      },
      pendingApproval: {
        id: 'aosh.drm.application:review.step.tagText.pendingApproval',
    ...
    description: defineMessages({
      transferOfMachine: {
        id: 'aosh.drm.application:review.step.description.transferOfMachine',
        defaultMessage:
      ...
      payment: {
        id: 'aosh.drm.application:review.step.description.payment',
      ...
      buyer: {
        id: 'aosh.drm.application:review.step.description.buyer',
        defaultMessage:
  ...
  buttons: defineMessages({
    back: {
      id: 'aosh.drm.application:review.buttons.back',
      defaultMessage: 'Til baka',
      description: 'Back button in review process',
    },
    reject: {
      id: 'aosh.drm.application:review.buttons.reject',
      defaultMessage: 'Hafna',
      description: 'Reject button in review process',
    },
    approve: {
      id: 'aosh.drm.application:review.buttons.approve',
