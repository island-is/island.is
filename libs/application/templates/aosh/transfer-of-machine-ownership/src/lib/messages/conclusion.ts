...
export const conclusion = {
  general: defineMessages({
    title: {
      id: 'aosh.application:conclusion.general.title',
      defaultMessage: 'Staðfesting',
      description: 'Title of conclusion screen',
    },
    sectionTitle: {
      id: 'aosh.application:conclusion.general.sectionTitle',
      defaultMessage: 'Staðfesting',
      description: 'Title of conclusion screen',
    },
    approvedTitle: {
      id: 'aosh.application:conclusion.general.approvedTitle',
      defaultMessage: 'Eigendaskipti samþykkt',
      description: 'Approved title of conclusion screen',
    },
    rejectedTitle: {
      id: 'aosh.application:conclusion.general.rejectedTitle',
  ...
  default: defineMessages({
    alertMessage: {
      id: 'aosh.application:conclusion.default.alertMessage',
      defaultMessage: 'Skráning móttekin!',
      description: 'Conclusion seller alert message',
    },
    accordionTitle: {
      id: 'aosh.application:conclusion.default.accordionTitle',
    ...
    goToStatusButton: {
      id: 'aosh.application:conclusion.default.goToStatusButton',
      defaultMessage: 'Skoða stöðu',
      description: 'Button on conclusion screen',
    },
    shareLink: {
      id: 'aosh.application:conclusion.default.shareLink',
      defaultMessage: 'Hlekkur á umsóknina',
      description: 'Share link button on conclusion screen',
    },
    copyLink: {
      id: 'aosh.application:conclusion.default.copyLink',
  ...
  review: defineMessages({
    accordionText: {
      id: 'aosh.application:conclusion.review.accordionText',
  ...
  approved: defineMessages({
    accordionText: {
      id: 'aosh.application:conclusion.approved.accordionText',
  ...
  rejected: defineMessages({
    alertMessage: {
      id: 'aosh.application:conclusion.rejected.alertMessage',
    ...
    secondText: {
      id: 'aosh.application:conclusion.rejected.secondText',
    ...
    startNewApplication: {
      id: 'aosh.application:conclusion.rejected.startNewApplication',
