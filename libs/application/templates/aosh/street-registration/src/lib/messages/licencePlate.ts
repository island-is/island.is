...
export const licencePlate = {
  general: defineMessages({
    ...
    subTitle: {
      id: 'aosh.drm.application:licencePlate.general.subTitle',
      defaultMessage: 'Veldu stærð merkis',
      description: 'Title of licencePlate subTitle',
    },
    subTitleDescription: {
      id: 'aosh.drm.application:licencePlate.general.subTitleDescription',
      defaultMessage:
  ...
  labels: defineMessages({
    plate110: {
      id: 'aosh.drm.application:licencePlate.labels.plate110',
      defaultMessage: 'Stærð A (110x510cm)',
      description: 'Label for licence plate A',
    },
    plate200: {
      id: 'aosh.drm.application:licencePlate.labels.plate200',
      defaultMessage: 'Stærð B (200x280cm)',
      description: 'Label for licence plate B',
    },
    plate155: {
      id: 'aosh.drm.application:licencePlate.labels.plate155',
