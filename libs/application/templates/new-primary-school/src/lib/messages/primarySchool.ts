...
export const primarySchoolMessages = {
  ...
  newSchool: defineMessages({
    ...
    subSectionMessage: {
      ...
      description: 'If a school does not appear in the list, the enrollment period has not yet begun in the relevant municipality. Further information about the enrollment period can be found on the municipality\'s website.',
    },
    alertMessage: {
