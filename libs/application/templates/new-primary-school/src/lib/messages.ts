...
export const newPrimarySchoolMessages: MessageDir = {
  ...
  conclusion: defineMessages({
    ...
    continuingEnrollmentExpandableDescription: {
      id: 'nps.application:conclusion.continuing.enrollment.expandable.description#markdown',
      defaultMessage:
        'Umsóknin fer núna til umfjöllunar hjá sveitarfélaginu þar sem að barnið er með skráð lögheimili. Þar verður tekin afstaða til þess hvort að sveitarfélagið geti greitt fyrir skólavistina. Staðfesting á greiðslu er forsenda þess að umsóknin fari svo til afgreiðslu hjá skólanum sjálfum.\n\nSkólinn mun að lokum svara þér um ákvörðun sína eins fljótt og auðið er með bréfi sem sent verður í stafræna pósthólfið þitt á Ísland.is.\n\nAthugið að upp getur komið sú staða að skólinn geti ekki orðið við ósk forsjáraðila, en það fer eftir fjölda lausra plássa, fjölda umsókna og aðstæðum í skólanum á hverjum tíma.\n\nFari svo að skóli sjái sér ekki fært að veita barni áframhaldandi skólavist, verður barnið skráð í sinn hverfisskóla, þar sem það á ávalt rétt á plássi.',
      description:
        'The application will now be considered by the municipality where the child has a registered legal domicile. A decision will be made as to whether the municipality can pay for the school fees. Confirmation of payment is a prerequisite for the application to be processed by the school itself.\n\nThe school will then inform you of their decision as soon as possible with a message sent to your digital mailbox at [Ísland.is](https://island.is).\n\nPlease note that there may be situations where the school cannot comply with the guardian’s request, but this depends on the number of available places, the number of applications and the conditions at the school at any given time.\n\n In the event that a school is unable to provide a child with continued schooling, the child will be enrolled in his local school, where he has the right to a place.',
    },
