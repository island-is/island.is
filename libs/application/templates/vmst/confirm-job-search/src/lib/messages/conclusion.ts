...
export const conclusion = defineMessages({
  completedFormAlertTitle: {
    id: 'vmst.cjs.conclusion:completedFormAlertTitle',
    defaultMessage:
  ...
  expandableIntro: {
    id: 'vmst.cjs.conclusion:expandableIntro#markdown',
    defaultMessage:
  ...
  descriptionFieldDescription: {
    id: 'vmst.cjs.conclusion:descriptionFieldDescription#markdown',
    defaultMessage:
