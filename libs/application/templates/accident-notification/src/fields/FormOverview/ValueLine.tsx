...
export const ValueLine: FC<React.PropsWithChildren<ValueLineProps>> = ({ label, value, color }) => {
...
export const FileValueLine: FC<React.PropsWithChildren<FileValueLineProps>> = ({ label, files }) => {
  const { formatMessage } = useLocale()
