...
import { isValid24HFormatTime, formatPhonenumber, getAttachmentTitles, returnMissingDocumentsList } from "./index"
...
describe('getAttachmentTitles', () => {
    it.each([
        ...
        const isHospitalSendsCertificate = injuryCertificate === AttachmentsEnum.HOSPITALSENDSCERTIFICATE
        ...
        expectedResults.push({
                ...
                description: 'Name of additional attachments for in review from applicant',
        })
        expectedResults.push({
        ...
        const result = getAttachmentTitles(answers as unknown as AccidentNotification)
...
describe('returnMissingDocumentsList', () => {
    it('should return missing documents list', () => {
        ...
        const result = returnMissingDocumentsList(missingDocuments as unknown as AccidentNotification, formatMessage)
