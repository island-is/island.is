...
// As this is a second question the user is asked there is a case where he could go back and select home activities and keep the sport acident type.
...
export const isProfessionalAthleteAccident = (formValue: FormValue) => {
  ...
  return (
    workAccidentType === WorkAccidentTypeEnum.PROFESSIONALATHLETE &&
