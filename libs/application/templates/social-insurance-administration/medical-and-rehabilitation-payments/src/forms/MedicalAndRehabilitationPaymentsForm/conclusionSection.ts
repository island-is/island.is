...
export const conclusionSection = buildFormConclusionSection({
  ...
  alertMessage: medicalAndRehabilitationPaymentsFormMessage.conclusion.alertMessage,
  expandableIntro: medicalAndRehabilitationPaymentsFormMessage.conclusion.next,
  expandableDescription: medicalAndRehabilitationPaymentsFormMessage.conclusion.entitlements,
})
