...
export const medicalAndRehabilitationPaymentsFormMessage: MessageDir = {
  ...
  notEligible: defineMessages({
    ...
    noLegalDomicileinIcelandDescription: {
      ...
      description:
        'The reason for this is the following:\n* You do not have legal domicile in Iceland.\n\nFurther information on requirements for medical and rehabilitation can be found at [tr.is](https://island.is/sjukra-og-endurhaefingargreidslur))\n\nIf you do not think the above applies to you, please contact the Social Insurance Administration at [endurhaefing@tr.is](mailto:endurhaefing@tr.is)',
    },
    hasActivePaymentsDescription: {
      id: 'marp.application:not.eligible.already.has.pending.application.description#markdown',
      defaultMessage:
