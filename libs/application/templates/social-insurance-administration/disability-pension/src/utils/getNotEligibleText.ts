...
export const notEligibleText = (externalData: ExternalData) => {
  ...
  switch (isEligible?.reasonCode) {
    case NotEligibleReasonCodes.APPLICANT_AGE_OUT_OF_RANGE:
      return disabilityPensionFormMessage.notEligible.applicantAgeOutOfRangeDescription
    case NotEligibleReasonCodes.NO_LEGAL_DOMICILE_IN_ICELAND:
      return disabilityPensionFormMessage.notEligible.noLegalDomicileInIcelandDescription
    case NotEligibleReasonCodes.LATEST_DISABILITY_PENSION_DOCUMENT_NOT_FOUND:
      return disabilityPensionFormMessage.notEligible.latestDisabilityPensionDocumentNotFoundDescription
    case NotEligibleReasonCodes.APPLICANT_ALREADY_HAS_PENDING_APPLICATION:
      return disabilityPensionFormMessage.notEligible.applicantAlreadyHasPendingApplicationDescription
    case NotEligibleReasonCodes.APPLICANT_ALREADY_HAS_FULL_DISABILITY_PENSION:
      return disabilityPensionFormMessage.notEligible.applicantAlreadyHasFullDisabilityPensionDescription
    default:
      return undefined
  }
}
