...
export const INTEREST_ON_DEPOSITS_IN_FOREIGN_BANKS = 'Vextir af innstæðum í erlendum bönkum'
export const DIVIDENDS_IN_FOREIGN_BANKS = 'Arður af hlutabréfa eign í erlendum bönkum'
