...
export const applicationForMessages = {
  A_FULL: defineMessages({
    title: {
      id: 'dl.application:shared.afull',
      defaultMessage: 'Fullnaðarréttindi',
      description: 'A-full',
    },
    rightsDescription: {
      id: 'dl.application:shared.afull.rightDescription',
      defaultMessage: 'A flokki (mótorhjól)',
      description: 'A-full license rights description',
    },
  }),
  A_TEMP: defineMessages({
    title: {
      id: 'dl.application:shared.atemp',
      defaultMessage: 'Almenn ökuréttindi',
      description: 'A-temp',
    },
    rightsDescription: {
      id: 'dl.application:shared.atemp.rightDescription',
      defaultMessage: 'A flokki (mótorhjól)',
      description: 'A-temp license rights description',
    },
  }),
  ...
  C_FULL: defineMessages({
    title: {
      id: 'dl.application:shared.cfull',
      defaultMessage: 'Fullnaðarréttindi',
      description: 'C-full',
    },
    rightsDescription: {
      id: 'dl.application:shared.cfull.rightDescription',
      defaultMessage: 'C flokki (stórbifreið)',
      description: 'C-full license rights description',
    },
  }),
  C_TEMP: defineMessages({
    title: {
      id: 'dl.application:shared.ctemp',
      defaultMessage: 'Almenn ökuréttindi',
      description: 'C-temp',
    },
    rightsDescription: {
      id: 'dl.application:shared.ctemp.rightDescription',
      defaultMessage: 'C flokki (stórbifreið)',
      description: 'C-temp license rights description',
    },
  }),
  D_FULL: defineMessages({
    title: {
      id: 'dl.application:shared.dfull',
      defaultMessage: 'Fullnaðarréttindi',
      description: 'D-full',
    },
    rightsDescription: {
      id: 'dl.application:shared.dfull.rightDescription',
      defaultMessage: 'D flokki (stórbifreið)',
      description: 'D-full license rights description',
    },
  }),
  D_TEMP: defineMessages({
    title: {
      id: 'dl.application:shared.dtemp',
      defaultMessage: 'Almenn ökuréttindi',
      description: 'D-temp',
    },
    rightsDescription: {
      id: 'dl.application:shared.dtemp.rightDescription',
      defaultMessage: 'D flokki (stórbifreið)',
      description: 'D-temp license rights description',
    },
  }),
}
