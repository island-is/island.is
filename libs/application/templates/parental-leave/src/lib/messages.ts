...
export const parentalLeaveFormMessages: MessageDir = {
  ...
  residenceGrantMessage: defineMessages({
    ...
    residenceGrantClosedDescription: {
      ...
      defaultMessage: 'Ekki er hægt að sækja um dvalarstyrk fyrr en eftir að barn er fætt. Sækja skal um innan sex mánaða frá fæðingardegi barns.',
      description: 'The residence grant cannot be applied for until after the child is born. Applications shall be applied for within six months from the date of delivery.',
    },
