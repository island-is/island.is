...
export const applicant = {
  ...
  labels: {
    userInformation: defineMessages({
      ...
      emailPhoneSubtitle: {
        id:
          'ta.dtdc.application:applicant.labels.userInformation.emailPhoneSubtitle',
      ...
      qualityPhotoSubtitle: {
        id:
          'ta.dtdc.application:applicant.labels.userInformation.qualityPhotoSubtitle',
      ...
      qualitySignatureSubtitle: {
        id:
          'ta.dtdc.application:applicant.labels.userInformation.qualitySignatureSubtitle',
    ...
    cardDelivery: defineMessages({
      ...
      legalDomicileOptionTitle: {
        id:
          'ta.dtdc.application:applicant.labels.cardDelivery.legalDomicileOptionTitle',
        defaultMessage: 'Sent á lögheimili',
        description: 'Legal domicile option title',
      },
      transportAuthorityOptionTitle: {
        id:
          'ta.dtdc.application:applicant.labels.cardDelivery.transportAuthorityOptionTitle',
      ...
      chooseDeliveryNoteText: {
        id:
          'ta.dtdc.application:applicant.labels.cardDelivery.chooseDeliveryNoteText',
        defaultMessage:
