...
export const exemptionPeriod = {
  general: defineMessages({
    ...
    description: {
      ...
      defaultMessage:
        'Skammtímaundanþágur eru ætlaðar fyrir staka flutninga til skemmri tíma. Langtímaundanþága eru ætlaðar fyrir tíða flutninga innan ákveðins svæðis til lengri tíma. ',
