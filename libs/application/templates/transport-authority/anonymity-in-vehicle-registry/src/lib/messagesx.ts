...
export const m = defineMessages({
  ...
  userProfileInformationTitle: {
    id: 'ta.avr.application:userprofile.title',
    defaultMessage: 'Netfang og símanúmer úr þínum stillingum',
    description: 'Your user profile information',
  },
  userProfileInformationSubTitle: {
    id: 'ta.avr.application:userprofile.subTitle',
    defaultMessage:
  ...
  confirmation: {
    id: 'ta.avr.application:confirmation',
  ...
  openMySites: {
    id: 'ta.avr.application:openMySites',
    defaultMessage: 'Opna mínar síður',
    description: 'Open my sites',
  },
  successTitle: {
    id: 'ta.avr.application:successTitle',
    defaultMessage:
      'Beiðni þín um nafnleynd í ökutækjaskrá hefur verið staðfest',
    description: '',
  },
  successDescription: {
    id: 'ta.avr.application:successDescription',
    defaultMessage: ' ',
    description: '',
  },
  actionCardPayment: {
