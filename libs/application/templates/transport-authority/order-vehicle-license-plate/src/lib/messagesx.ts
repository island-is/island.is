...
export const m = defineMessages({
  ...
  userProfileInformationTitle: {
    id: 'ta.ovlp.application:userprofile.title',
    defaultMessage: 'Netfang og símanúmer úr þínum stillingum',
    description: 'Your user profile information',
  },
  userProfileInformationSubTitle: {
    id: 'ta.ovlp.application:userprofile.subTitle',
    defaultMessage:
  ...
  confirmation: {
    id: 'ta.ovlp.application:confirmation',
  ...
  openMySites: {
    id: 'ta.ovlp.application:openMySites',
    defaultMessage: 'Opna mínar síður',
    description: 'Open my sites',
  },
  successTitle: {
    id: 'ta.ovlp.application:successTitle',
    defaultMessage: 'Pöntun þín á skráningarmerki hefur verið staðfest',
    description: '',
  },
  successDescription: {
    id: 'ta.ovlp.application:successDescription',
    defaultMessage: ' ',
    description: '',
  },
  actionCardPayment: {
