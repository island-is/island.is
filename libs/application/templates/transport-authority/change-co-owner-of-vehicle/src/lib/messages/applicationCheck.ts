...
export const applicationCheck = {
  submitApplication: defineMessages({
    sellerNotValid: {
      id: 'ta.ccov.application:applicationCheck.submitApplication.sellerNotValid',
      defaultMessage:
  ...
  validation: defineMessages({
    alertTitle: {
      id: 'ta.ccov.application:applicationCheck.validation.alertTitle',
      defaultMessage: 'Það kom upp villa',
      description: 'Application check validation alert title',
    },
    alertInfoTitle: {
      id: 'ta.ccov.application:applicationCheck.validation.alertInfoTitle',
      defaultMessage: 'Til athugunar!',
      description: 'Alert title',
    },
    fallbackErrorMessage: {
      id: 'ta.ccov.application:applicationCheck.validation.fallbackErrorMessage',
      defaultMessage: 'Það kom upp villa við að sannreyna gögn',
      description: 'Fallback error message for validation',
    },
    E2: {
      id: 'ta.ccov.application:applicationCheck.validation.E2',
      defaultMessage:
    ...
    E43: {
      id: 'ta.ccov.application:applicationCheck.validation.E43',
      defaultMessage:
    ...
    E49: {
      id: 'ta.ccov.application:applicationCheck.validation.E49',
      defaultMessage:
    ...
    E50: {
      id: 'ta.ccov.application:applicationCheck.validation.E50',
      defaultMessage:
        'Ökutæki með ferðaþjónustuleyfi, þarf að fara í breytingaskoðun og breyta í almenna notkun fyrir sölu.',
      description: 'Message for validation error no 50',
    },
    E58: {
      id: 'ta.ccov.application:applicationCheck.validation.E58',
      defaultMessage:
    ...
    E61: {
      id: 'ta.ccov.application:applicationCheck.validation.E61',
      defaultMessage:
    ...
    E62: {
      id: 'ta.ccov.application:applicationCheck.validation.E62',
      defaultMessage:
    ...
    E63: {
      id: 'ta.ccov.application:applicationCheck.validation.E63',
      defaultMessage:
    ...
    E64: {
      id: 'ta.ccov.application:applicationCheck.validation.E64',
      defaultMessage:
    ...
    E66: {
      id: 'ta.ccov.application:applicationCheck.validation.E66',
      defaultMessage:
    ...
    E67: {
      id: 'ta.ccov.application:applicationCheck.validation.E67',
      defaultMessage:
    ...
    E68: {
      id: 'ta.ccov.application:applicationCheck.validation.E68',
      defaultMessage:
        'Eigendaskiptaálestur hefur ekki farið fram innan sjö daga, lesa þarf af ökutækinu',
      description: 'Message for validation error no 68',
    },
    E69: {
      id: 'ta.ccov.application:applicationCheck.validation.E69',
      defaultMessage:
        'Eigendaskiptaálestur hefur ekki farið fram innan sjö daga, lesa þarf af ökutækinu',
      description: 'Message for validation error no 69',
    },
    E70: {
      id: 'ta.ccov.application:applicationCheck.validation.E70',
      defaultMessage:
        'Ökutæki með ferðaþjónustuleyfi, þarf að fara í breytingaskoðun og breyta í almenna notkun fyrir sölu.',
      description: 'Message for validation error no 70',
    },
    E71: {
      id: 'ta.ccov.application:applicationCheck.validation.E71',
      defaultMessage:
        'Ökutæki í ökutækjaleigu og með ferðaþjónustuleyfi, þarf að fara í breytingaskoðun og breyta í almenna notkun fyrir sölu.',
      description: 'Message for validation error no 71',
    },
    E72: {
      id: 'ta.ccov.application:applicationCheck.validation.E72',
      defaultMessage:
        'Ökutæki með ferðaþjónustuleyfi, þarf að fara í breytingaskoðun og breyta í almenna notkun fyrir sölu.',
      description: 'Message for validation error no 72',
    },
    E74: {
      id: 'ta.ccov.application:applicationCheck.validation.E74',
      defaultMessage:
        'Ökutæki í ökutækjaleigu og með ferðaþjónustuleyfi, þarf að fara í breytingaskoðun og breyta í almenna notkun fyrir sölu.',
      description: 'Message for validation error no 74',
    },
    E78: {
      id: 'ta.ccov.application:applicationCheck.validation.E78',
      defaultMessage:
