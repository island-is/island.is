...
export const RejectedConclusion: FC<React.PropsWithChildren<FieldBaseProps>> = (props) => {
  ...
  return (
    <Box>
      ...
      <Box display="flex" justifyContent="flexEnd" marginTop={8}>
        <Link
          href={`${document.location.origin}/umsoknir/${ApplicationConfigurations.ChangeCoOwnerOfVehicle.slug}/`}
        >
          <Button>
