...
export const m = defineMessages({
  ...
  userProfileInformationTitle: {
    id: 'ta.ovrc.application:userprofile.title',
    defaultMessage: 'Netfang og símanúmer úr þínum stillingum',
    description: 'Your user profile information',
  },
  userProfileInformationSubTitle: {
    id: 'ta.ovrc.application:userprofile.subTitle',
    defaultMessage:
  ...
  confirmation: {
    id: 'ta.ovrc.application:confirmation',
  ...
  openMySites: {
    id: 'ta.ovrc.application:openMySites',
    defaultMessage: 'Opna mínar síður',
    description: 'Open my sites',
  },
  successTitle: {
    id: 'ta.ovrc.application:successTitle',
    defaultMessage: 'Pöntun þín á skráningarskírteini hefur verið staðfest',
    description: '',
  },
  successDescription: {
    id: 'ta.ovrc.application:successDescription',
    defaultMessage: ' ',
    description: '',
  },
  actionCardPayment: {
