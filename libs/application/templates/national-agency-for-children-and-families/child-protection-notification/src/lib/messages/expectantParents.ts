...
export const expectantParentsMessages = defineMessages({
  sectionTitle: {
    id: 'cpn.application:expectantParents.sectionTitle',
    defaultMessage: 'Verðandi foreldrar',
    description: 'Expectant parents section title',
  },
  description: {
    id: 'cpn.application:expectantParents.description',
    defaultMessage:
  ...
  radioLabel: {
    id: 'cpn.application:expectantParents.radioLabel',
    defaultMessage:
