  ...
  return (
    <>
      <Text variant="h5" as="h3">
        {formatMessage(summary.otherCostsHeader)}
      </Text>
        ...
        <GridRow className={gridRow}>
          ...
          <GridColumn span={['12/12', '4/12']}>
            <KeyValue
              ...
              value={otherFeesPayee(
                answers.rentOtherFees.heatingCost as string,
              )}
            />
          </GridColumn>
          <GridColumn span={['12/12', '4/12']}>
            <KeyValue
              ...
              value={otherFeesPayee(
                answers.rentOtherFees.housingFund as string,
              )}
            />
          </GridColumn>
        </GridRow>
            ...
            <GridRow className={gridRow}>
              ...
              <GridColumn span={['12/12', '4/12']}>
                <KeyValue
                  ...
                  value={answers.rentOtherFees.electricityCostMeterStatusDate}
                />
              </GridColumn>
            </GridRow>
          </>
