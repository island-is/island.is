import {
  ...
  export const titleSubsection = buildSubSection({
    id: 'titleSubsection',
    title: 'Title',
    children: [
      buildMultiField({
        ...
        children: [
          buildTitleField({
              title: 'The title form field is a simpler version of the description field, but with the ability to customize color.',
              titleVariant: 'h3',
              marginTop: 0,
              marginBottom: 3,
          }),
