...
export const childSupportPayments = {
  general: defineMessages({
    sectionTitle: {
      id:
        'crc.application:section.arrangement.childSupportPayment.sectionTitle',
      defaultMessage: 'Framfærsla og meðlag',
      description: 'Child support payments section title',
    },
    description: {
      id:
        'crc.application:section.arrangement.childSupportPayment.description#markdown',
      defaultMessage:
    ...
    infoText: {
      id:
        'crc.application:section.arrangement.childSupportPayment.infoText#markdown',
      defaultMessage:
  ...
  radioAgreement: defineMessages({
    title: {
      id:
        'crc.application:section.arrangement.childSupportPayment.radioAgreement.title',
      defaultMessage: 'Samkomulag er um framfærslu',
      description: 'Agreement radio title',
    },
    description: {
      id:
        'crc.application:section.arrangement.childSupportPayment.radioAgreement.description',
  ...
  radioChildSupport: defineMessages({
    title: {
      id:
        'crc.application:section.arrangement.childSupportPayment.radioChildSupport.title',
      defaultMessage: 'Greiðsla meðlags',
      description: 'Child support radio title',
    },
    description: {
      id:
        'crc.application:section.arrangement.childSupportPayment.radioChildSupport.description',
      defaultMessage:
