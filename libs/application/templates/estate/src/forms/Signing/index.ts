      ...
      children: [
        buildMultiField({
          ...
          children: [
            ...
            // SignatoryStatus owns the live lookup and disables this action
            // until the latest successful response has no pending signers.
            // Keeping the action visible lets a successful in-screen refresh
            // recover applications that entered signing after a transient
            // lookup failure.
            buildSubmitField({
