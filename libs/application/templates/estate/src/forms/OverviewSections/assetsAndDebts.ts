...
export const overviewAssetsAndDebts = [
  ...
  buildDescriptionField({
    ...
    description: ({ answers }) =>
      getValueViaPath(answers, 'estate.inventory.info'),
    titleVariant: 'h4',
    space: 'gutter',
    condition: (answers) =>
      getValueViaPath(answers, 'estate.inventory.info') !== '',
  ...
  buildDescriptionField({
    ...
    condition: (answers) =>
      getValueViaPath(answers, 'estate.inventory.value') !== '',
    titleVariant: 'h4',
    marginBottom: 'gutter',
    space: 'gutter',
  }),
  ...
  buildDescriptionField({
    ...
    title: m.total,
    description: ({ answers }) =>
      getSumFromAnswers<EstateSchema['estate']['claims']>(
        answers,
        'estate.claims',
        'value',
      ),
  ...
  buildDescriptionField({
    ...
    title: m.total,
    description: ({ answers }) =>
      getSumFromAnswers<EstateSchema['estate']['stocks']>(
        answers,
        'estate.stocks',
        'value',
      ),
  ...
  buildDescriptionField({
    ...
    title: m.total,
    description: ({ answers }) =>
      getSumFromAnswers<EstateSchema['estate']['otherAssets']>(
        answers,
        'estate.otherAssets',
        'value',
      ),
  ...
  buildCustomField(
    ...
    {
      cards: ({ answers }: Application) =>
        ((answers as unknown as EstateSchema).debts?.data ?? []).map(
          (debt) => ({
  ...
  buildDescriptionField({
    ...
    title: m.total,
    description: ({ answers }) =>
      getSumFromAnswers(answers, 'debts.data', 'balance'),
    condition: (answers) =>
      !!getSumFromAnswers(answers, 'debts.data', 'balance'),
    titleVariant: 'h4',
  }),
