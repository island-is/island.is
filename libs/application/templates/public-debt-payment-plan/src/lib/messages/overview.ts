...
export const overview = defineMessages({
  ...
  phoneNumber: {
    ...
    defaultMessage: 'Sími',
    description: 'Overview phone number',
  },
  address: {
    id: `pdpp.application:application.overview.address`,
    defaultMessage: 'Heimilisfang',
    description: 'Overview address',
  },
  email: {
    id: `pdpp.application:application.overview.email`,
    defaultMessage: 'Netfang',
    description: 'Overview email',
  },
  employer: {
    id: `pdpp.application:application.overview.employer`,
    defaultMessage: 'Vinnuveitandi',
    description: 'Overview employer',
  },
  employerSsn: {
    id: `pdpp.application:application.overview.employerSsn`,
