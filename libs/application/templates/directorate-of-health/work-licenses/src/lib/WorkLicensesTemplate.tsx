...
import { WorkLicenseSchema } from './dataSchema'
...
const template: ApplicationTemplate<
  ...
  Events
> = {
  type: ApplicationTypes.DIRECTORATE_OF_HEALTH_WORK_LICENSE,
  name: applicationMessage.name,
  institution: applicationMessage.institutionName,
  translationNamespaces: [
    ApplicationConfigurations.DirectorateOfHealthWorkLicense.translation,
  ],
  dataSchema: WorkLicenseSchema,
  featureFlag: Features.DirectorateOfHealthWorkLicense,
  stateMachineConfig: {
