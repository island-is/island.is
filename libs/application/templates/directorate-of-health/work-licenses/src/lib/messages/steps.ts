...
export const review = {
  general: defineMessages({
    title: {
      id: 'dh.wl.application:review.general.title',
      defaultMessage: 'Yfirlit eigendaskipta',
      description: 'Title of overview screen',
    },
    description: {
      id: 'dh.wl.application:review.general.description',
      defaultMessage:
  ...
  buttons: defineMessages({
    back: {
      id: 'dh.wl.application:review.buttons.back',
      defaultMessage: 'Til baka',
      description: 'Back button in review process',
    },
    reject: {
      id: 'dh.wl.application:review.buttons.reject',
      defaultMessage: 'Hafna',
      description: 'Reject button in review process',
    },
    approve: {
      id: 'dh.wl.application:review.buttons.approve',
