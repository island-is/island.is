            ...
            buildMultiField({
              ...
              children: [
                buildAlertMessageField({
                  ...
                  title: messages.equalityReport.previousEqualityPlan.alertTitle,
                  message: (application: Application) => {
                    const date = getValueViaPath<string>(
                      application.externalData,
                      'activeEqualityReport.data.validUntil',
                    )
                    const formatted = date ? format(new Date(date), 'dd.MM.yyyy') : ''
                ...
                buildTextField({
                  ...
                  title: messages.equalityReport.previousEqualityPlan.approvedAt,
                  width: 'half',
                  disabled: true,
                ...
                buildTextField({
                  ...
                  title: messages.equalityReport.previousEqualityPlan.validUntil,
                  width: 'half',
                  disabled: true,
                  defaultValue: (application: Application) => {
                    const date = getValueViaPath<string>(
