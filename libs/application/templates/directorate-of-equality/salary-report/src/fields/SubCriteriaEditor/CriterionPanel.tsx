...
import { DEFAULT_SUB_CRITERION, type SubCriterion } from '../../lib/constants'
...
const mapParsedToSubCriteria = (parsed: ParsedSubCriterionDto[]): SubCriterion[] =>
  parsed.map((sc) => (
    {
    title: sc.title,
...
export const CriterionPanel: FC<Props> = ({
  ...
  return (
    <AccordionCard
      ...
      visibleContent={formatMessage(messages.report.subCriteria.criterionWeightLabel, {
