...
export const signatoryStatusSection = buildSection({
  id: 'signatoryStatus',
  title: m.inReviewSignatoriesTitle,
  children: [
    buildMultiField({
      id: 'signatoryStatusMultiField',
      title: m.inReviewSignatoriesTitle,
      description: m.inReviewSignatoriesDescription,
      children: [
        buildStaticTableField({
          title: m.inReviewSignatoriesTableTitle,
          marginTop: 3,
          header: [
        ...
        buildDescriptionField({
          ...
          title: m.inReviewActionsInfoTitle,
          description: m.inReviewActionsInfoDescription,
          titleVariant: 'h3',
          space: 6,
          marginTop: 7,
        }),
