...
export const m = defineMessages({
  ...
  mainSectionParticipantHeading: {
    id: 'hh.courses.application:mainSectionParticipantHeading',
    defaultMessage: 'Þátttakandi',
    description: 'Label for participant national id',
  },
  mainSectionParticipantEmail: {
    id: 'hh.courses.application:mainSectionParticipantEmail',
    defaultMessage: 'Netfang',
    description: 'Label for participant email',
  },
  mainSectionParticipantPhoneNumber: {
    id: 'hh.courses.application:mainSectionParticipantPhoneNumber',
    defaultMessage: 'Símanúmer',
    description: 'Label for participant phone number',
  },
  mainSectionPayerHeading: {
    id: 'hh.courses.application:mainSectionPayerHeading',
    defaultMessage: 'Greiðandi reiknings',
    description: 'Heading for payer segment',
  },
  mainSectionPayerNationalId: {
    id: 'hh.courses.application:mainSectionPayerNationalId',
    defaultMessage: 'Kennitala',
    description: 'Label for payer national id',
  },
  mainSectionPayerName: {
    id: 'hh.courses.application:mainSectionPayerNationalId',
    defaultMessage: 'Nafn',
