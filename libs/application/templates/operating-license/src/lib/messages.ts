...
export const m = defineMessages({
  ...
  introSectionTitle: {
    id: 'ol.application:introSection.title',
    defaultMessage: 'Rekstrarleyfi',
    description: 'Some description',
  },
  dataCollectionTitle: {
    id: 'ol.application:dataCollection.title',
    defaultMessage: 'Gagnaöflun',
    description: 'Some description',
  },
  dataCollectionSubtitle: {
    id: 'ol.application:dataCollection.subtitle',
    defaultMessage: 'Eftirfarandi gögn verða sótt rafrænt',
    description: 'Some description',
  },
  dataCollectionCheckboxLabel: {
    id: 'ol.application:dataCollection.checkboxLabel',
  ...
  proceedToPayment: {
    id: 'ol.application:payment.proceedToPayment',
    defaultMessage: 'Greiða',
    description: 'Some description',
  },
  paymentSection: {
    id: 'ol.application:payment.section',
    defaultMessage: 'Staðfesting og greiðsla',
    description: 'Some description',
  },
  paymentSectionTitle: {
    id: 'ol.application:payment.section.title',
    defaultMessage: 'Greiðsla',
    description: 'Some description',
  },
  payment: {
    id: 'ol.application:payment',
    defaultMessage: 'Ganga frá greiðslu',
    description: 'Some description',
  },
  confirm: {
    id: 'ol.application:confirm',
    defaultMessage: 'Staðfesta',
    description: 'Some description',
  },
  errorDataProvider: {
    id: 'ol.application:error.dataProvider',
  ...
  applicationCompleteTotal: {
    id: 'ol.application:complete.total',
