...
export const prerequisites = {
  general: defineMessages({
    formTitle: {
      id: 'ojoi.application:prerequisites.general.formTitle',
      defaultMessage: 'Upplýsingar um innsendingar',
      description: 'Title of prerequisites form',
    },
    formIntro: {
      id: 'ojoi.application:prerequisites.general.formIntro',
      defaultMessage:
    ...
    sectionTitle: {
      id: 'ojoi.application:prerequisites.general.sectionTitle',
