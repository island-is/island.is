...
import * as m from './messages/application'
...
const template: ApplicationTemplate<
  ...
  Events
> = {
  type: ApplicationTypes.NAMSKEID_HH,
  name: m.application.applicationName,
  codeOwner: CodeOwners.Origo,
  featureFlag: Features.NamskeidHhEnabled,
  institution: m.application.institutionName,
  translationNamespaces:
    ApplicationConfigurations[ApplicationTypes.NAMSKEID_HH].translation,
