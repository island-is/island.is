...
const basePartiesSchema = z.object({
...
export const partiesSchema = basePartiesSchema.pipe(
  // Using pipe allows table schemas to run first
  z
    .custom<z.infer<typeof basePartiesSchema>>()
