...
export const childrenForm = {
  general: defineMessages({
    sectionTitle: {
      id: 'fa.application:section.childrenForm.general.sectionTitle',
      defaultMessage: 'Börn',
      description: 'About form section title',
    },
    pageTitle: {
      id: 'fa.application:section.childrenForm.general.pageTitle',
      defaultMessage: 'Börn',
      description: 'About form page title',
    },
    description: {
      id: 'fa.application:section.childrenForm.general.description',
      defaultMessage:
  ...
  page: defineMessages({
    content: {
      id: 'fa.application:section.childrenForm.page.content#markdown',
      defaultMessage:
    ...
    birthday: {
      id: 'fa.application:section.childrenForm.page.birthday',
  ...
  inputs: defineMessages({
    kindergardenLabel: {
      id: 'fa.application:section.childrenForm.inputs.kindergardenLabel',
      defaultMessage: 'Leikskóli',
      description: 'Label for kindergarden input',
    },
    kindergardenPlaceholder: {
      id: 'fa.application:section.childrenForm.inputs.kindergardenPlaceholder',
    ...
    elementarySchoolLabel: {
      id: 'fa.application:section.childrenForm.inputs.elementarySchoolLabel',
      defaultMessage: 'Grunnskóli',
      description: 'Label for elementary school input',
    },
    elementarySchoolPlaceholder: {
      id: 'fa.application:section.childrenForm.inputs.elementarySchoolPlaceholder',
    ...
    elementarySchoolFoodCheck: {
      id: 'fa.application:section.childrenForm.inputs.elementarySchoolFoodCheck',
    ...
    elementarySchoolAfterSchoolCheck: {
      id: 'fa.application:section.childrenForm.inputs.elementarySchoolAfterSchoolCheck',
    ...
    highSchoolPlaceholder: {
      id: 'fa.application:section.childrenForm.inputs.highSchoolPlaceholder',
      defaultMessage: 'Í hvaða framhaldsskóla er barnið?',
      description:
        'Placeholder in input where asking about the childs high school name',
    },
    highSchoolLabel: {
      id: 'fa.application:section.childrenForm.inputs.highSchoolLabel',
