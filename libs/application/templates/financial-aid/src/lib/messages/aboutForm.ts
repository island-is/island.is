...
export const aboutForm = {
  ...
  bulletList: defineMessages({
    first: {
      id: 'fa.application:section.aboutForm.bulletList.first',
      defaultMessage:
        '<ul><li>Til að eiga rétt á fjárhagsaðstoð þurfa tekjur og eignir þínar að vera undir ákveðnum viðmiðunarmörkum.</li> <li>Fjárhagsaðstoð getur verið í formi láns eða styrks. </li><li> Áður en þú sækir um fjárhagsaðstoð skaltu athuga hvort þú eigir rétt á annarskonar aðstoð. Dæmi um önnur úrræði eru <a href="https://www.stjornarradid.is/verkefni/almannatryggingar-og-lifeyrir/almannatryggingar/" target="_blank" rel="noopener noreferrer">almannatryggingar</a>, <a href="https://vinnumalastofnun.is/umsoknir/umsokn-um-atvinnuleysisbaetur" target="_blank" rel="noopener noreferrer">atvinnuleysisbætur</a>, <a href="https://www.lifeyrismal.is/is/sjodirnir" target="_blank" rel="noopener noreferrer">lífeyrissjóðir</a>, <a href="https://www.sjukra.is/" target="_blank" rel="noopener noreferrer">Sjúkratryggingar Íslands</a> og sjúkrasjóðir stéttarfélaga.</li> <li>Ef þú ert í lánshæfu námi gætir þú átt rétt á námsláni hjá <a href="https://menntasjodur.is/" target="_blank" rel="noopener noreferrer">Menntasjóði námsmanna</a></li> </ul>',
