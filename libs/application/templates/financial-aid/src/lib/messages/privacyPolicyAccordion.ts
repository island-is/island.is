...
export const privacyPolicyAccordion = {
  ...
  accordion: defineMessages({
    ...
    about: {
      id:
        'fa.application:section.privacyPolicyAccordion.accordion.about#markdown',
      defaultMessage:
    ...
    moreInfoHomepage: {
      id:
        'fa.application:section.privacyPolicyAccordion.accordion.moreInfoHomepage#markdown',
      defaultMessage:
