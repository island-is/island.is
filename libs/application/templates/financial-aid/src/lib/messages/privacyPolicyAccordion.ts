...
export const privacyPolicyAccordion = {
  general: defineMessages({
    sectionTitle: {
      ...
      description: 'Privacy policy section title',
    },
  }),
  accordion: defineMessages({
    ...
    about: {
      id: 'fa.application:section.privacyPolicyAccordion.accordion.about#markdown',
      defaultMessage:
    ...
    moreInfoHomepage: {
      id: 'fa.application:section.privacyPolicyAccordion.accordion.moreInfoHomepage#markdown',
      defaultMessage:
