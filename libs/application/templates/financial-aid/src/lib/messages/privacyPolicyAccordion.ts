...
export const privacyPolicyAccordion = {
  general: defineMessages({
    sectionTitle: {
      id: 'fa.application:section.privacyPolicyAccordion.general.sectionTitle',
      defaultMessage: 'Vinnsla persónuupplýsinga',
      description: 'Privacy policy accordion section title',
    },
    accordionTitle: {
      id:
        'fa.application:section.privacyPolicyAccordion.general.accordionTitle',
      defaultMessage: 'Nánar um persónuverndarstefnu þíns sveitarfélags',
      description: 'Privacy policy accordion title',
    },
    accordionAbout: {
      id:
        'fa.application:section.privacyPolicyAccordion.general.accordionAbout#markdown',
      defaultMessage:
    ...
    accordionMoreInfo: {
      id:
        'fa.application:section.privacyPolicyAccordion.general.accordionMoreInfo',
      defaultMessage:
    ...
    accordionMoreInfoHomepage: {
      id:
        'fa.application:section.privacyPolicyAccordion.general.accordionMoreInfoHomepage#markdown',
      defaultMessage:
        'Frekari upplýsingar um vinnslu persónuupplýsinga hjá sveitarfélaginu má finna í persónuverndarstefnu þess sem aðgengileg er á vefsíðunni [{homePageNameUrl}]({homePageNameUrl}).',
      description: 'Privacy policy accordion more info text with homepage',
    },
  }),
}
