...
export const addFieldsRepeaterSubsection = (
  section: SectionBuilder,
): SectionBuilder =>
  section.addSubSection(
    'fieldsRepeaterSubsection',
    'Fields Repeater Field',
    (subSection) => {
      subSection.addPage('fieldsRepeater', 'Fields Repeater', (page) => {
        page
          .addDescriptionField('fieldsRepeaterDescription', '', {
            description:
          ...
          .addFieldsRepeaterField('fieldsRepeater', 'Fields Repeater', {
