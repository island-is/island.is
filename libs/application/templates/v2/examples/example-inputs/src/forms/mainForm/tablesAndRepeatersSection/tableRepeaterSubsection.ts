...
import { SectionBuilder, coreErrorMessages } from '@island.is/application/core'
import { Application } from '@island.is/application/types'
import { friggOrganizationsByTypeQuery } from '../../../graphql/sampleQuery'

export const addTableRepeaterSubsection = (
  section: SectionBuilder,
): SectionBuilder =>
  section.addSubSection('repeater', 'Table Repeater', (subSection) => {
    subSection.addPage('tableRepeater', 'Table Repeater Field', (page) => {
      page
        .addDescriptionField('tableRepeaterDescription', '', {
          description:
        ...
        .addDescriptionField('tableRepeaterDescription2', '', {
          description:
        ...
        .addTableRepeaterField('tableRepeater', 'Table Repeater Field', {
