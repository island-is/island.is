...
export const addPaginatedSearchableTableSubsection = (
  ...
  section.addSubSection(
    ...
    (subSection) => {
      subSection.addPage(
        'paginatedSearchableTableMultiField',
        'Paginated searchable table field',
        (page) => {
          page
            .addDescriptionField('paginatedSearchableTableDescription', '', {
              description:
            ...
            .addPaginatedSearchableTableField('paginatedSearchableTable', {
