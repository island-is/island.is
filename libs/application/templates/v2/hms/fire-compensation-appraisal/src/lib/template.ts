...
const template: ApplicationTemplate<
  ...
  Events
> = {
  type: ApplicationTypes.FIRE_COMPENSATION_APPRAISAL_SDF,
  ...
  translationNamespaces:
    ApplicationConfigurations.FireCompensationAppraisalSdf.translation,
  dataSchema,
  allowedDelegations: [
    {
        ...
        meta: {
          ...
          onExit: [
            defineTemplateApi({
              ...
              namespace: ApplicationTypes.FIRE_COMPENSATION_APPRAISAL,
              order: 1,
            }),
          ],
          roles: [
            {
              ...
              write: 'all',
              read: 'all',
              api: [SearchPropertiesApi, FetchPropertiesByCodeApi],
              delete: true,
            },
            {
              id: Roles.DELEGATE,
