...
export const m = defineMessages({
  customComponentDescription: {
    id: 'ef.application:customComponentDescription',
    defaultMessage:
  ...
  customComponentNumberedList: {
    id: 'ef.application:customComponentDescription#markdown',
    defaultMessage:
  ...
  customComponentAbout: {
    id: 'ef.application:customComponentAbout',
    defaultMessage:
  ...
  overviewTitle: {
    id: 'ef.application:overviewTitle',
    defaultMessage: 'Overview',
    description: 'Overview title',
  },
  overviewDescriptionText: {
    id: 'ef.application:overviewDescriptionText',
    defaultMessage:
  ...
  overviewInfoDescripton: {
    id: 'ef.application:overviewInfoDescripton',
    defaultMessage:
  ...
  overviewFileDescription: {
    id: 'ef.application:overviewFileDescription',
    defaultMessage:
