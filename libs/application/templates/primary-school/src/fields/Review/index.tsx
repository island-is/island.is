      ...
      {state === `${States.DRAFT}` && (
        <Box display="flex" justifyContent="spaceBetween">
          <Box>
            <Box marginBottom={2}>
              <Text variant="h2">
                {formatMessage(primarySchoolMessages.overview.sectionTitle)}
              </Text>
            </Box>
            <Box marginBottom={10}>
              <Text variant="default">
                {formatMessage(
                  primarySchoolMessages.overview.overviewDescription,
                )}
              </Text>
            </Box>
          </Box>
        ...
        >
          ...
          <Box display="flex" columnGap={2} alignItems="center">
            {state !== `${States.DRAFT}` && (
              ...
              >
                {formatMessage(primarySchoolMessages.overview.editButton)}
              </Button>
            )}
            <Button
              variant="utility"
