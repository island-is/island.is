          ...
          <>
            <GridRow>
              <GridColumn span="10/12">
                <RadioValue
                  label={formatMessage(
                    primarySchoolMessages.differentNeeds.acceptFreeSchoolLunch,
                  )}
            ...
            {acceptFreeSchoolLunch === YES && (
              <GridRow>
                <GridColumn span="12/12">
                  <RadioValue
                    label={formatMessage(
                      primarySchoolMessages.differentNeeds.hasSpecialNeeds,
                    )}
            ...
            {acceptFreeSchoolLunch === YES && hasSpecialNeeds === YES && (
              <GridRow>
                <GridColumn span="12/12">
                  <DataValue
                    label={formatMessage(
                      primarySchoolMessages.differentNeeds.specialNeedsType,
                    )}
