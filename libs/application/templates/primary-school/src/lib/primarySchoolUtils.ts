...
import { primarySchoolMessages } from './messages'
...
export const getApplicationAnswers = (answers: Application['answers']) => {
  ...
  if (!applicationType) applicationType = ApplicationType.PRIMARY_SCHOOL
...
export const determineNameFromApplicationAnswers = (
  ...
  return applicationType === ApplicationType.ENROLLMENT_IN_PRIMARY_SCHOOL
    ? primarySchoolMessages.shared.enrollmentApplicationName
    : primarySchoolMessages.shared.applicationName
}
...
export const formatGender = (genderCode?: string): MessageDescriptor => {
  switch (genderCode) {
    case '1':
    case '3':
      return primarySchoolMessages.shared.male
    case '2':
    case '4':
      return primarySchoolMessages.shared.female
    case '7':
    case '8':
    default:
      return primarySchoolMessages.shared.otherGender
  }
}
