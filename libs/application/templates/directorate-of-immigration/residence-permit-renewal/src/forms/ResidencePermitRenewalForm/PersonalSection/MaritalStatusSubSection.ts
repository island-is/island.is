    ...
    buildMultiField({
      ...
      children: [
        ...
        buildTextField({
          ...
          width: 'half',
          readOnly: true,
          defaultValue: (application: Application) => 'Giftur', // TODOx
        }),
        buildDescriptionField({
          id: 'maritalStatus.title',
        ...
        buildTextField({
          ...
          readOnly: true,
          format: '######-####',
          defaultValue: (application: Application) => '0123456789', // TODOx
        }),
        buildTextField({
          ...
          width: 'half',
          readOnly: true,
          defaultValue: (application: Application) => 'Jane Smith', // TODOx
        }),
      ],
    }),
  ],
