...
export const externalData = {
  ...
  directorateOfImmigration: defineMessages({
    title: {
      id: 'doi.cs.application:externalData.directorateOfImmigration.title',
      defaultMessage: 'Upplýsingar til Útlendingastofnunar',
      description: 'Directorate of immigration title',
    },
    subTitle: {
      id: 'doi.cs.application:externalData.directorateOfImmigration.subTitle',
      defaultMessage:
  ...
  icelandRevenueAndCustoms: defineMessages({
    title: {
      id: 'doi.cs.application:externalData.icelandRevenueAndCustoms.title',
