import { FieldComponents, FieldTypes, NationalRegistryParent } from '@island.is/application/types'
...
export const Parents = ({
    ...
    return (
        <div>
            { parents.length > 1 && parents.map((p, index) => {
                return (
                    <GridRow marginTop={0}>
                        <DescriptionText 
                            text={index === 1 ? information.labels.parents.parentOneTitle : information.labels.parents.parentTwoTitle }
                            textProps={{
                                as: 'h5',
                                fontWeight: 'semiBold',
                                paddingBottom: 1,
                        ...
                        <GridColumn span={['1/1', '1/1', '1/2']} paddingTop={2}>
                            <InputController
                                ...
                                label={personal.labels.userInformation.nationalId.defaultMessage}
                                readOnly
                                format='######-####'
            ...
            {parents.length === 1 && (
                <Box>
                    ...
                    <NationalIdWithName
                        ...
                        customNameLabel={personal.labels.userInformation.name.defaultMessage}
                        customNationalIdLabel={personal.labels.userInformation.nationalId.defaultMessage}
