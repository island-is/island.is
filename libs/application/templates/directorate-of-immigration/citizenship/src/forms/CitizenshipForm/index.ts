...
import { DefaultEvents, Form, FormModes, Section } from '@island.is/application/types'
        ...
        buildMultiField({
          ...
          children: [
            ...
            buildNationalIdWithNameField({
              id: 'nationalidwithnamefieldid',
              title: 'nationalIdWithNameFieldTitle',
              required: false,
              width: 'full',
            }),
            ...
            buildTableRepeaterField({
              id: 'tablerepeaterfieldid',
              title: 'tableFieldRepeaterTitle',
              fields: {
                name: {
                  component: 'input',
                  label: 'test 1',
