...
const ResidenceHistoryTable: FC<ResidenceHistoryTableProps> = ({
  ...
  const columns = [
    {
      Header: formatText(
        childPensionFormMessage.residence.residenceHistoryCountryTableHeader,
        application,
        formatMessage,
      ),
      accessor: 'country',
    ...
    {
      Header: formatText(
        childPensionFormMessage.residence.residenceHistoryPeriodFromTableHeader,
        application,
        formatMessage,
      ),
      accessor: 'periodFrom',
    ...
    {
      Header: formatText(
        childPensionFormMessage.residence.residenceHistoryPeriodToTableHeader,
        application,
        formatMessage,
      ),
      accessor: 'periodTo',
