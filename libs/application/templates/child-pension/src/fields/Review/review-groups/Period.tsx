...
import { isMoreThan2Year } from '../../../lib/childPensionUtils'
    ...
    >
      <GridRow>
        <GridColumn span={['12/12', '12/12', '12/12', '5/12']}>
          <DataValue
            label={formatMessage(childPensionFormMessage.period.periodTitle)}
      ...
      {isMoreThan2Year(application.answers) && (
        <p style={{ color: '#B30038', fontSize: '14px', fontWeight: '500' }}>
          {formatMessage(childPensionFormMessage.errors.period)}
        </p>
      )}
    </ReviewGroup>
  )
