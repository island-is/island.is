  ...
  return (
          ...
          <GridRow>
            ...
            >
              <InputController
                ...
                label={formatMessage(childPensionFormMessage.confirm.email)}
                onChange={(e) =>
                  setStateful((prev) => ({
                    ...prev,
          ...
          <GridRow>
            <GridColumn span={['12/12', '12/12', '12/12', '7/12']}>
              <PhoneInputController
                ...
                backgroundColor="blue"
                label={formatMessage(
                  childPensionFormMessage.confirm.phonenumber,
                )}
                onChange={(e) => {
                  setStateful((prev) => ({
                    ...prev,
    ...
    >
      {applicantName !== '' && (
        <GridRow marginBottom={3}>
          <GridColumn span={['12/12', '12/12', '12/12', '5/12']}>
            <DataValue
              label={formatMessage(childPensionFormMessage.confirm.name)}
              value={applicantName}
            />
          </GridColumn>
          <GridColumn span={['12/12', '12/12', '12/12', '5/12']}>
            <DataValue
              label={formatMessage(childPensionFormMessage.confirm.nationalId)}
      ...
      <GridRow>
        ...
        <GridColumn span={['12/12', '12/12', '12/12', '5/12']}>
          <DataValue
            label={formatMessage(childPensionFormMessage.confirm.phonenumber)}
