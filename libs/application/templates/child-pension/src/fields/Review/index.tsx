    ...
    <>
      {state === `${States.DRAFT}` && (
        <Box display="flex" justifyContent="spaceBetween">
          <Box>
            <Box marginBottom={2}>
              <Text variant="h2">
                {formatMessage(childPensionFormMessage.confirm.title)}
              </Text>
            </Box>
            <Box marginBottom={10}>
              <Text variant="default">
                {formatMessage(childPensionFormMessage.confirm.description)}
              </Text>
            </Box>
          </Box>
          <Box>
      ...
      {canView && (
        ...
        >
          <Box>
            <Text variant="h2">
              {formatMessage(childPensionFormMessage.confirm.overviewTitle)}
            </Text>
          </Box>
          ...
          <Box display="flex" columnGap={2} alignItems="center">
            {state === `${States.TRYGGINGASTOFNUN_SUBMITTED}` && (
              ...
              >
                {formatMessage(childPensionFormMessage.confirm.buttonEdit)}
              </Button>
            )}
            <Button
              variant="utility"
