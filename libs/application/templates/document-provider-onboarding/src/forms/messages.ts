...
export const m = defineMessages({
  ...
  applicantTitle: {
    id: 'dpo.application:applicant.title',
    defaultMessage: 'Umsækjandi',
    description: '',
  },
  applicantSubTitle: {
  ...
  applicantNationalId: {
    id: 'dpo.application:applicant.nationalid',
  ...
  applicantEmail: {
    id: 'dpo.application:applicant.email',
  ...
  applicantAddress: {
    id: 'dpo.application:applicant.address',
  ...
  administrativeContactTitle: {
    id: 'dpo.application:administrativeContact.title',
    defaultMessage: 'Ábyrgðarmaður',
    description: '',
  },
  ...
  administrativeContactName: {
    id: 'dpo.application:administrativeContact.name',
    defaultMessage: 'Nafn',
    description: '',
  },
  ...
  technicalContactTitle: {
    id: 'dpo.application:technicalContact.title',
    defaultMessage: 'Tæknilegur tengiliður',
    description: '',
  },
  ...
  technicalContactName: {
    id: 'dpo.application:technicalContact.name',
    defaultMessage: 'Nafn',
    description: '',
  },
  ...
  testTechnicalImplementationMessage1: {
    id: 'dpo.application:technicalImplementation.message1',
    defaultMessage:
      'Þegar forritunarskilum er lokið er hægt að koma aftur að umsókninni til að klára ferlið. Það er á ábyrgð skjalaveitanda að forritunarskilin uppfylli öryggiskröfur og kröfur um virkni.',
    description: '',
  },
  ...
  automatedTestsSubTitle: {
    id: 'dpo.application:automatedTests.subTitle',
    defaultMessage:
      'Tilgangur þessa prófs er að sannreyna að skjalaveita geti sent notanda skjal og að notandi geti nálgast skjal hjá skjalaveitu.',
    description: '',
  },
  automatedTestsSubHeading: {
  ...
  automatedTestsNationalIdLabel: {
    id: 'dpo.application:automatedTests.nationalIdLabel',
  ...
  automatedTestsNationalIdErrorMessage: {
    id: 'dpo.application:automatedTests.nationalIdErrorMessage',
    defaultMessage: 'Þú verður að skrá inn kennitölu móttakanda',
    description: '',
  },
  automatedTestsDocIdErrorMessage: {
    id: 'dpo.application:automatedTests.docIdErrorMessage',
