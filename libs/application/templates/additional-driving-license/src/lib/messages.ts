...
export const m = defineMessages({
  nationalCommissionerOfPolice: {
    id: 'adl.application:nationalCommissionerOfPolice',
  ...
  chooseDistrictCommissionerForFullLicense: {
    id: 'adl.application:chooseDistrictCommissionerForFullLicense',
    defaultMessage:
  ...
  chooseDistrictCommissionerForTempLicense: {
    id: 'adl.application:chooseDistrictCommissionerForTempLicense',
    defaultMessage:
  ...
  existingApplicationExists: {
    id: 'adl.application:error.existingApplicationExists',
  ...
  userProfileInformationTitle: {
    id: 'adl.application:userprofile.title',
    defaultMessage: 'Netfang og símanúmer úr þínum stillingum',
    description: 'Your user profile information',
  },
  userProfileInformationSubTitle: {
    id: 'adl.application:userprofile.subTitle',
    defaultMessage:
  ...
  confirmationStatusOfEligability: {
    id: 'adl.application:confirmationStatusOfEligability',
    defaultMessage:
  ...
  drivingLicenseApplyingForTitle: {
    id: 'adl.application:drivingLicenseApplyingForTitle',
    defaultMessage: 'Ég er að sækja um:',
    description: 'I am applying for:',
  },
  applicationForFullLicenseTitle: {
    id: 'adl.application:applicationForFullLicenseTitle',
  ...
  applicationForFullLicenseDescription: {
    id: 'adl.application:applicationForFullLicenseDescription',
    defaultMessage:
  ...
  applicationForTempLicenseTitle: {
    id: 'adl.application:applicationForTempLicenseTitle',
  ...
  applicationForTempLicenseDescription: {
    id: 'adl.application:applicationForTempLicenseDescription',
    defaultMessage:
  ...
  infoFromLicenseRegistry: {
    id: 'adl.application:infoFromLicenseRegistry',
  ...
  applicationDenied: {
    id: 'adl.application:applicationDenied',
    defaultMessage: 'Umsókn hafnað',
    description: 'Application denied',
  },
  applicationForBAdvancedDescription: {
    id: 'adl.application:applicationForBAdvancedDescription',
  ...
  applicationForDrivingLicense: {
    id: 'adl.application:applicationForDrivingLicense',
    defaultMessage: 'Umsókn um ökuskírteini',
    description: 'Application for driving license',
  },
  applicationForBELicenseTitle: {
    id: 'adl.application:applicationForBELicenseTitle',
  ...
  applicationForBELicenseDescription: {
    id: 'adl.application:applicationForBELicenseDescription',
    defaultMessage:
  ...
  applicationForAdvancedLicenseTitle: {
    id: 'adl.application:applicationForAdvancedLicenseTitle',
  ...
  applicationForAdvancedLicenseDescription: {
    id: 'adl.application:applicationForAdvancedLicenseDescription',
    defaultMessage:
  ...
  applicationForAdvancedLicenseLabelD1A: {
    id: 'adl.application:applicationForAdvancedLicenseLabelD1A',
    defaultMessage: 'Sækja um leyfi í atvinnuskyni',
    description: 'D1A description',
  },
  applicationForAdvancedLicenseTitleC: {
    id: 'adl.application:applicationForAdvancedLicenseTitleC',
    defaultMessage: 'Vörubíll (C)',
    description: 'C title',
  },
  applicationForAdvancedLicenseLabelC: {
    id: 'adl.application:applicationForAdvancedLicenseLabelC',
    defaultMessage:
  ...
  applicationForAdvancedLicenseLabelCA: {
    id: 'adl.application:applicationForAdvancedLicenseLabelCA',
    defaultMessage: 'Sækja um leyfi í atvinnuskyni',
    description: 'CA description',
  },
  applicationForAdvancedLicenseTitleD: {
    id: 'adl.application:applicationForAdvancedLicenseTitleD',
    defaultMessage: 'Stór rúta (D)',
    description: 'D title',
  },
  applicationForAdvancedLicenseLabelD: {
    id: 'adl.application:applicationForAdvancedLicenseLabelD',
    defaultMessage:
  ...
  applicationForAdvancedLicenseLabelDA: {
    id: 'adl.application:applicationForAdvancedLicenseLabelDA',
    defaultMessage: 'Sækja um leyfi í atvinnuskyni',
    description: 'DA description',
  },
  applicationForAdvancedLicenseTitleC1E: {
    id: 'adl.application:applicationForAdvancedLicenseTitleC1E',
    defaultMessage: 'Minni vörubíll og eftirvagn (C1E)',
    description: 'C1E title',
  },
  applicationForAdvancedLicenseLabelC1E: {
    id: 'adl.application:applicationForAdvancedLicenseLabelC1E',
    defaultMessage:
  ...
  applicationForAdvancedLicenseTitleD1E: {
    id: 'adl.application:applicationForAdvancedLicenseTitleD1E',
    defaultMessage: 'Lítil rúta og eftirvagn (D1)',
    description: 'D1E title',
  },
  applicationForAdvancedLicenseLabelD1E: {
    id: 'adl.application:applicationForAdvancedLicenseLabelD1E',
    defaultMessage:
  ...
  applicationForAdvancedLicenseTitleCE: {
    id: 'adl.application:applicationForAdvancedLicenseTitleCE',
    defaultMessage: 'Vörubíll og eftirvagn (CE)',
    description: 'CE title',
  },
  applicationForAdvancedLicenseLabelCE: {
    id: 'adl.application:applicationForAdvancedLicenseLabelCE',
    defaultMessage:
  ...
  applicationForAdvancedLicenseTitleDE: {
    id: 'adl.application:applicationForAdvancedLicenseTitleDE',
    defaultMessage: 'Stór rúta og eftirvagn (DE)',
    description: 'DE title',
  },
  applicationForAdvancedLicenseLabelDE: {
    id: 'adl.application:applicationForAdvancedLicenseLabelDE',
    defaultMessage:
  ...
  applicationForAdvancedRequiredError: {
    id: 'adl.application:applicationForAdvancedRequiredError',
    defaultMessage: 'Þú verður að velja að minnsta kosti einn valmöguleika',
    description: 'You must select at least one option',
  },
  yes: {
    id: 'adl.application:shared.yes',
    defaultMessage: 'Já',
    description: 'Yes',
  },
  no: {
    id: 'adl.application:shared.no',
    defaultMessage: 'Nei',
    description: 'No',
  },
  informationSectionTitle: {
    id: 'adl.application:informationSection.title',
    defaultMessage: 'Sýslumannsembætti',
    description: 'Information',
  },
  pickupLocationTitle: {
    id: 'adl.application:pickupLocationTitle',
    defaultMessage: 'Afhendingarstaður',
    description: 'location for pickup',
  },
  pickupLocationDescription: {
    id: 'adl.application:pickupLocationDescription',
    defaultMessage:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.',
    description: 'location for pickup',
  },
  deliveryMethodHeader: {
    id: 'adl.application:deliveryMethodHeader',
  ...
  healthDeclarationMultiField65DescriptionRedesigned: {
    id: 'adl.application:healthDeclarationMultiField65DescriptionRedesigned#markdown',
    defaultMessage:
  ...
  healthDeclarationMultiFieldSubTitle: {
    id: 'adl.application:healthDeclarationMultiField.subTitle',
  ...
  healthDeclarationSubTitle: {
    id: 'adl.application:healthDeclarationSubTitle',
    defaultMessage:
  ...
  alertHealthDeclarationGlassesMismatch: {
    id: 'adl.application:alertHealthDeclarationGlassesMismatch',
    defaultMessage:
  ...
  healthDeclaration1: {
    id: 'adl.application:healthDeclaration.1',
  ...
  healthDeclaration2: {
    id: 'adl.application:healthDeclaration.2',
    defaultMessage:
  ...
  healthDeclaration3: {
    id: 'adl.application:healthDeclaration.3',
    defaultMessage:
  ...
  healthDeclaration4: {
    id: 'adl.application:healthDeclaration.4',
    defaultMessage:
  ...
  healthDeclaration5: {
    id: 'adl.application:healthDeclaration.5',
  ...
  healthDeclaration6: {
    id: 'adl.application:healthDeclaration.6',
    defaultMessage:
  ...
  healthDeclaration7: {
    id: 'adl.application:healthDeclaration.7',
    defaultMessage:
  ...
  healthDeclaration8: {
    id: 'adl.application:healthDeclaration.8',
  ...
  healthDeclaration9: {
    id: 'adl.application:healthDeclaration.9',
    defaultMessage:
  ...
  healthDeclaration10: {
    id: 'adl.application:healthDeclaration.10',
    defaultMessage:
  ...
  drivingLicenseTypeRequested: {
    id: 'adl.application:drivingLicenseTypeRequested',
    defaultMessage: 'Réttindi sem sótt er um',
    description: 'Driving license type that is requested',
  },
  informationFullName: {
    id: 'adl.application:informationFullName',
    defaultMessage: 'Nafn',
    description: 'Full Name',
  },
  informationStreetAddress: {
    id: 'adl.application:informationStreetAddress',
    defaultMessage: 'Heimilisfang',
    description: 'Street address',
  },
  informationYourEmail: {
    id: 'adl.application:informationYourEmail',
    defaultMessage: 'Netfangið þitt',
    description: 'Your email',
  },
  drivingInstructor: {
    id: 'adl.application:drivingInstructor',
    defaultMessage: 'Ökukennari',
    description: 'Driving instructor',
  },
  drivingLicenseInOtherCountry: {
    id: 'adl.application:drivingLicenseInOtherCountry',
  ...
  noDeprivedDrivingLicenseInOtherCountryDescription: {
    id: 'adl.application:noDeprivedDrivingLicenseInOtherCountryDescription',
    defaultMessage:
  ...
  applicationForRenewalLicenseTitle: {
    id: 'adl.application:applicationForRenewalLicenseTitle',
  ...
  phoneNumberTitle: {
    id: 'adl.application:phoneNumberTitle',
    defaultMessage: 'Símanúmer',
    description: 'Phone number',
  },
  photoSelectionTitle: {
    id: 'adl.application:photoSelection.title',
    defaultMessage: 'Mynd í ökuskírteini',
    description: 'Photo selection section title',
  },
  photoSelectionDescription: {
    id: 'adl.application:photoSelection.description',
    defaultMessage:
  ...
  usePassportImage: {
    id: 'adl.application:photoSelection.usePassportImage#markdown',
    defaultMessage:
  ...
  useDriversLicenseImage: {
    id: 'adl.application:photoSelection.useDriversLicenseImage#markdown',
    defaultMessage:
  ...
  healthCertificateTitle: {
    id: 'adl.application:healthCertificate.title',
    defaultMessage: 'Læknisvottorð',
    description: 'Health certificate title',
  },
  healthCertificateDescription: {
    id: 'adl.application:healthCertificate.description',
    defaultMessage:
  ...
  healthCertificateUploadHeader: {
    id: 'adl.application:healthCertificate.uploadHeader',
  ...
  healthCertificateUploadDescription: {
    id: 'adl.application:healthCertificate.uploadDescription',
    defaultMessage:
  ...
  qualityPhotoWarningTitle: {
    id: 'adl.application:qualityPhotoWarningTitle',
  ...
  qualityPhotoWarningDescription: {
    id: 'adl.application:qualityPhotoWarningDescription',
    defaultMessage:
  ...
  healthRemarksDescription: {
    id: 'adl.application:healthRemarksDescriptionV2',
    defaultMessage:
...
export const requirementsMessages = defineMessages({
  rlsAcceptedDescription: {
    id: 'adl.application:requirementunmet.accepted',
  ...
  rlsDefaultDeniedDescription: {
    id: 'adl.application:requirementunmet.deniedbyservicedescription',
    defaultMessage:
  ...
  invalidLicense: {
    id: 'adl.application:requirementunmet.invalidlicense',
    defaultMessage:
  ...
  hasPointsOrDeprivation: {
    id: 'adl.application:requirementunmet.haspointsordeprivation',
    defaultMessage:
  ...
  currentLocalResidencyDescription: {
    id: 'adl.application:requirementunmet.currentLocalResidencyDescription',
    defaultMessage:
  ...
  beLicenseQualityPhotoTitle: {
    id: 'adl.application:requirementunmet.beLicenseQualityPhotoTitle',
    defaultMessage: 'Gæðavottuð mynd',
    description:
      'requirement unmet api returned false for an unspecified reason',
  },
  beLicenseQualityPhotoDescription: {
    id: 'adl.application:requirementunmet.beLicenseQualityPhotoDescriptionV2',
    defaultMessage:
  ...
  noExtendedDrivingLicenseTitle: {
    id: 'adl.application:requirementunmet.noExtendedDrivingLicenseTitle',
  ...
  noExtendedDrivingLicenseDescription: {
    id: 'adl.application:requirementunmet.noExtendedDrivingLicenseDescription#markdown',
    defaultMessage: 'Ekki hægt að sækja um endurnýjun á 65+ ökuskírteini.',
    description: 'requirement unmet 65 plus renewal',
  },
})
