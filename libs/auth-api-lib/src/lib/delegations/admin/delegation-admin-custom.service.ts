...
export class DelegationAdminCustomService {
  ...
  toName: string,
    ...
    try {
      ...
      this.logger.error(`Failed to send delegation notification to delegation representative`, e)
    }
    ...
    try {
      ...
      this.logger.error(`Failed to send delegation notification to delegation provider`, e)
    }
  }
