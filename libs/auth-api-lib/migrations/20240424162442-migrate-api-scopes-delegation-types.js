...
module.exports = {
  async up(queryInterface) {
    await queryInterface.sequelize.query(`
      BEGIN;
        INSERT INTO api_scope_delegation_types (api_scope, delegation_type)
        SELECT name, 'Custom'
        FROM api_scope
        ...
        INSERT INTO api_scope_delegation_types (api_scope, delegation_type)
        SELECT prsp.api_scope_name AS api_scope, CONCAT('PersonalRepresentative:', prrt.code) AS delegation_type
