...
module.exports = {
  async up(queryInterface) {
     ...
     */
    // Commenting this out as it has already been run on prod and it will not work when running the migration locally with a clean db as the domain will not be present in the database.
    // In the future changes like this should be done in a script or a seed file.
