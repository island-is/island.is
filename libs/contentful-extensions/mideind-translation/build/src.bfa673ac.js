      ...
      function (require, module, exports) {
        ...
        !(function (t, n) {
          ...
          var l = a(function (e, t) {
              ...
              t.Signal = r
              var o = '__private__memoized__arguments__',
                a = (function (e) {
                  function t() {
                  ...
                  return (
                    ...
                    (t.prototype.dispatch = function () {
                      for (var t = [], n = 0; n < arguments.length; n++)
                        t[n] = arguments[n]
                      ;(this[o] = t), e.prototype.dispatch.apply(this, t)
                    }),
                    (t.prototype.attach = function (t) {
                      var n = e.prototype.attach.call(this, t)
                      return t.apply(void 0, this[o]), n
                    }),
                    t
                  )
                })(r)
              ;(t.MemoizedSignal = a), (n = o)
            }),
            u = a(function (e, t) {
              Object.defineProperty(t, '__esModule', { value: !0 }),
                  ...
                  ;(this._messageHandlers = {}),
                    ...
                    (this._send = (function (e, t) {
                      ...
                      return function (r, o) {
                        ...
                        return (
                          t.postMessage(
                            { source: e, id: i, method: r, params: o },
                            '*',
                          ),
                          i
                        )
                ...
                return (
                  (e.prototype.call = function (e) {
                    for (var t = this, n = [], r = 1; r < arguments.length; r++)
                      n[r - 1] = arguments[r]
                    var o = this._send(e, n)
                    return new Promise(function (e, n) {
                      t._responseHandlers[o] = { resolve: e, reject: n }
                    })
                  }),
                  ...
                  (e.prototype.addHandler = function (e, t) {
                    return (
                      e in this._messageHandlers ||
                        (this._messageHandlers[e] = new l.Signal()),
                  ...
                  (e.prototype._handleMessage = function (e) {
                    if (e.method) {
                      ...
                      var o = e.id,
                        i = this._responseHandlers[o]
                      if (!i) return
                      'result' in e
                        ? i.resolve(e.result)
                        : 'error' in e && i.reject(e.error),
                        delete this._responseHandlers[o]
                    }
                  }),
                  e
                )
              ...
              var n = (function () {
                function e(e, t) {
                  ...
                  ;(this.id = t.id),
                    ...
                    (this.validations = t.validations),
                    (this.items = t.items),
                    (this._value = t.value),
                    (this._valueSignal = new l.MemoizedSignal(this._value)),
                    (this._isDisabledSignal = new l.MemoizedSignal(void 0)),
                    (this._schemaErrorsChangedSignal = new l.MemoizedSignal(
                      void 0,
                    )),
                    (this._channel = e),
                    ...
                    e.addHandler(
                      ...
                      function (e, t, r) {
                        e === n.id &&
                          t === n.locale &&
                          n._schemaErrorsChangedSignal.dispatch(r)
                      },
                    )
                }
                return (
                  ...
                  (e.prototype.removeValue = function () {
                    return (
                      (this._value = void 0),
                      this._channel.call('removeValue', this.id, this.locale)
                    )
                  }),
                ...
                r = (function () {
                  function e(e, t, r) {
                    ;(this.id = t.id),
                      ...
                      (this._fieldLocales = t.locales.reduce(function (r, o) {
                        var a,
                          l = new n.default(e, {
                            id: t.id,
                            type: t.type,
                  ...
                  return (
                    ...
                    (e.prototype.onValueChanged = function (e, t) {
                      var n = t || e
                      return (
                        t || (e = ''), this._getFieldLocale(e).onValueChanged(n)
                      )
                    }),
                    (e.prototype.onIsDisabledChanged = function (e, t) {
                      ...
                      return (
                        t || (e = ''),
                        this._getFieldLocale(e).onIsDisabledChanged(n)
                      )
                    }),
                    (e.prototype._getFieldLocale = function (e) {
                      return (
                        (e = e || this._defaultLocale),
                        this.assertHasLocale(e),
                        this._fieldLocales[e]
                      )
                    }),
                    (e.prototype.getForLocale = function (e) {
                      if (!e)
                        throw new Error('getForLocale must be passed a locale')
                      return this._getFieldLocale(e)
                    }),
                    (e.prototype.assertHasLocale = function (e) {
                      if (!this._fieldLocales[e])
                        throw new Error(
                          'Unknown locale "' +
                            e +
                            '" for field "' +
            ...
            h = a(function (e, t) {
              ...
              t.default = function (e, t) {
                ...
                return (
                  ...
                  (r.getCachedContentTypes = function () {
                    return i.__spreadArrays(t)
                  }),
                  r
                )
              }
            ...
            _ = a(function (e, t) {
              ...
              t.default = function (e, t) {
                return {
                  openAlert: r.bind(null, 'alert'),
                  openConfirm: r.bind(null, 'confirm'),
                  openPrompt: r.bind(null, 'prompt'),
                  openExtension: o,
                  openCurrentApp: a,
                  openCurrent: function (e) {
                    return t.app
                      ? a(e)
                      : o(i.__assign(i.__assign({}, e), { id: t.extension }))
                  },
                ...
                function r(t, r) {
                  return e.call('openDialog', t, n(r))
                }
                function o(r) {
                  if (
                    ((r = n(r)),
                    ...
                    return e.call('openDialog', 'extension', r)
                  throw new Error('Extension ID not provided.')
                }
                function a(r) {
                  if (((r = n(r)), t.app)) {
                    var o = i.__assign(i.__assign({}, r), { id: t.app })
                    return e.call('openDialog', 'app', o)
                  }
                ...
                function l(t, r, o) {
                  return (
                    ((o = n(o)).entityType = t),
                    (o.multiple = r),
                    e.call('openDialog', 'entitySelector', o)
                  )
                }
              }
            }),
            y = a(function (e, t) {
              Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.default = function (e, t) {
                  var n = new l.MemoizedSignal(void 0),
                    r = new l.MemoizedSignal(void 0)
                  return (
                  ...
                  return (
                    ...
                    }),
                    {
                      ...
                      openPageExtension: function (n) {
                        return e.call(
                          'navigateToPage',
                          i.__assign({ type: 'extension', id: t.extension }, n),
                        )
                      },
                      openCurrentAppPage: function (n) {
                        return e.call(
                          'navigateToPage',
                          i.__assign({ type: 'app', id: t.app }, n),
                        )
                      },
            ...
            g = a(function (e, t) {
              ...
              var n = 'preInstall',
                ...
                a = function (e) {
                  return console.error(e), Promise.resolve(!1)
                },
                l = function (e, t, n) {
                  if (!i(e)) return Promise.resolve(t)
                  var r
                  try {
                    r = void 0 === n ? e() : e(n)
                  } catch (e) {
                  ...
                  var l,
                    u = r
                  return (
                    (o((l = u)) && i(l.then)) || (u = Promise.resolve(u)),
                    u
                      .then(function (e) {
              ...
              t.default = function (e) {
                var t,
                  o = (((t = {}).preInstall = null), (t.postInstall = null), t),
                  a = function (e, t) {
                    if (!i(t)) throw new Error('Handler must be a function.')
                    o[e] = t
                  }
                return (
                  e.addHandler('appHook', function (t) {
                    ...
                    return i === n
                      ...
                      : i === r
                      ? l(o[i], void 0, u || null).then(function () {
                          return e.send('appHookResult', {
                            stage: i,
                            installationRequestId: a,
                          })
                  ...
                  }),
                  {
                    ...
                    getCurrentState: function () {
                      return e.call('callAppMethod', 'getCurrentState')
                    },
            ...
            b = a(function (e, t) {
              var n
              Object.defineProperty(t, '__esModule', { value: !0 })
              var r = i.__importDefault(f),
                o = i.__importDefault(c),
                a = i.__importDefault(d),
                l = i.__importDefault(p),
                u = i.__importDefault(h),
                s = i.__importDefault(_),
                b = i.__importDefault(y),
                w = i.__importDefault(v),
                E = i.__importDefault(g),
                O = i.__importDefault(m),
                A = [
                  C,
                  T,
                  function (e, t) {
                    ...
                    if (!n)
                      throw new Error(
                        'FieldAPI called for location without "field" property defined.',
                      )
                    return { field: new o.default(e, n) }
                  },
                  P,
                  S,
                ],
                I =
                  (((n = {})[O.default.LOCATION_ENTRY_FIELD] = A),
                  (n[O.default.LOCATION_ENTRY_FIELD_SIDEBAR] = A),
                  (n[O.default.LOCATION_ENTRY_SIDEBAR] = [C, T, P, S]),
                  (n[O.default.LOCATION_ENTRY_EDITOR] = [C, T, P]),
                  (n[O.default.LOCATION_DIALOG] = [
                    C,
                    function (e) {
                      return {
                        close: function (t) {
                  ...
                  (n[O.default.LOCATION_PAGE] = [C]),
                  (n[O.default.LOCATION_APP_CONFIG] = [
                    C,
                    function (e) {
                      return { app: E.default(e) }
                    },
                  ]),
                  n)
              function C(e, t) {
                var n = t.user,
                  ...
                  l = t.location || O.default.LOCATION_ENTRY_FIELD
                return {
                  location: {
                    is: function (e) {
                      return l === e
                  ...
                  space: u.default(e, a),
                  dialogs: s.default(e, i),
                  navigator: w.default(e, i),
                  notifier: {
                    success: function (t) {
                  ...
                  access: {
                    can: function (t, n) {
                      return e.call('checkAccess', t, n)
                    },
                  },
                }
              }
              function S(e, t, n) {
                return { window: a.default(n, e) }
              }
              function P(e, t) {
                var n = t.editorInterface
                return { editor: b.default(e, n) }
              }
              function T(e, t) {
                var n = t.locales,
                  o = t.contentType,
                ...
                return {
                  contentType: o,
                  entry: l.default(e, i, a, function (t) {
                    return new r.default(e, t, n.default)
                  }),
                }
              }
              t.default = function (e, t, n) {
                return (I[t.location] || A).reduce(function (r, o) {
                  return i.__assign(i.__assign({}, r), o(e, t, n))
                }, {})
              }
            }),
            w = i.__importDefault(s),
            E = i.__importDefault(b),
            O = i.__importDefault(m)
          return { init: w.default(window, E.default), locations: O.default }
        })
      },
      {},
    ],
      ...
      function (require, module, exports) {
        ...
        function e(e) {
          for (var t = '', n = 0, o = e; n < o.length; n++) {
            var r = o[n]
            r.nodeType && 'text' === r.nodeType && (t += r.value)
          }
          return [{ nodeType: 'text', value: t, marks: [], data: {} }]
        }
        function t(n, o) {
          if (
            o.nodeType &&
            ('paragraph' === o.nodeType && (o.content = e(o.content)),
            'text' === o.nodeType && o.value.length > 0 && n.push(o.value),
            o.content)
          )
            for (var r = 0, a = o.content; r < a.length; r++) {
              t(n, a[r])
            }
          return n
        }
        function n(t, o) {
          if (o.nodeType) {
            ...
            if (o.content)
              for (var a = 0, u = o.content; a < u.length; a++) {
                n(t, u[a])
              }
          }
        }
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.default = { extractText: o, createValue: r })
      },
      {},
    ],
    AY0S: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.default = { extractText: e, createValue: t })
      },
      {},
    ],
    GmYz: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.populateField = exports.extractField = void 0)
        var n = r(require('./widgets/richTextEditor')),
          i = r(require('./widgets/singleLine')),
          u = r(require('./widgets/multipleLine'))
        function o(e) {
          return (
            !!e.locales &&
            !(!e.locales.includes('en') || !e.locales.includes('is-IS'))
          )
        }
        function l(e, t) {
          if (o(e)) {
            var r = c(
                t.controls.filter(function (t) {
                  return t.fieldId === e.id
                })[0].widgetId,
              ),
              n = r.extractText
            if (r.ignore) return
            var i = e.getValue('is-IS')
            return i ? n(i) : []
          }
        }
        function a(r, n, i) {
          return e(this, void 0, void 0, function () {
            ...
            return t(this, function (t) {
              if (o(r)) {
                if (
                  ((e = n.controls.filter(function (e) {
                    return e.fieldId === r.id
                  })[0].widgetId),
                  (u = c(e)),
                  u.extractText,
                  (l = u.createValue),
                  ...
                  return [2]
                if (!(a = r.getValue('is-IS'))) return [2]
                ;(s = l(i, a)), r.setValue(s, 'en')
              }
              return [2]
            })
          })
        ...
        ;(exports.extractField = l), (exports.populateField = a)
      },
      {
        './widgets/richTextEditor': '38Sa',
        './widgets/singleLine': 'AY0S',
        './widgets/multipleLine': 'AY0S',
      },
    ],
    pVIn: [
      function (require, module, exports) {
        ...
        var r = 'https://stafraentisland.greynir.is/translate/',
          a = { sourceLanguageCode: 'is', targetLanguageCode: 'en' }
        function o(o) {
          return e(this, void 0, void 0, function () {
            var e, i, s, u, c, l
            return n(this, function (n) {
              switch (n.label) {
                    ...
                    [
                      ...
                      fetch(r, {
                        ...
                        headers: {
                          ...
                          'X-API-Key':
                            '7k1LmY5G.dRIx8zLDg2LZxPTYm5BxhanXj62MAeTq',
                        },
                ...
                case 1:
                  for (
                    s = n.sent(), u = 0, c = s.translations;
                    u < c.length;
                    u++
                  )
                    (l = c[u]), e.push(l.translatedText.trim())
                  return [2, e]
              }
            })
          })
        }
        exports.translateTexts = o
      },
      {},
    ],
    BPMY: [
      function (require, module, exports) {
        ...
        var i = n(require('react')),
          o = require('@contentful/forma-36-react-components'),
          a = require('react'),
          u = require('../fieldUtils/index'),
          l = require('../api'),
          c = function (n) {
            return e(void 0, void 0, void 0, function () {
              var e, i, o, a, c, s, f, d, h, p, v, y, b, w, g, _
              return t(this, function (t) {
                switch (t.label) {
                  case 0:
                    for (
                      ...
                      (v = s[c]),
                        (y = e[v]),
                        (b = n.editor.editorInterface),
                        (f =
                          null !== (_ = u.extractField(y, b)) && void 0 !== _
                            ? _
                            : []),
                        (o = r(o, f)),
                        a.push(f.length)
                    return [4, l.translateTexts(o)]
                  case 1:
                    for (
                      (d = t.sent()).reverse(), a.reverse(), h = 0, p = i;
                      h < p.length;
                      h++
                    )
                      (v = p[h]),
                        ...
                        (b = n.editor.editorInterface),
                        0 !== (w = 0 | a.pop()) &&
                          ((g = d.splice(-w)), u.populateField(y, b, g))
                    return [2]
                }
              })
            })
          ...
          s = function (r) {
            ...
            return i.default.createElement(
              ...
              i.default.createElement(
                ...
                u ? 'Translating...' : 'Translate to English',
              ),
              u && i.default.createElement(o.Spinner, null),
            )
          }
        exports.default = s
      },
    ...
    zo2T: [
      function (require, module, exports) {
        ...
        var i = r(require('react')),
          u = require('react-dom'),
          o = require('contentful-ui-extensions-sdk')
        require('@contentful/forma-36-react-components/dist/styles.css'),
          require('./index.css')
        var c = n(require('./components/Sidebar'))
        o.init(function (e) {
          u.render(
            i.createElement(c.default, { sdk: e }),
