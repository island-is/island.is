...
import { EducationLicense, EducationSignedLicense } from '../models/license'
import { FetchEducationSignedLicenseUrlInput } from '../dto/educationLicense.input'
import { ExamFamilyOverview, ExamResult } from '../models/grade'
