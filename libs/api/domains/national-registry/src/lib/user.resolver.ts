...
import { NationalRegistryUser, BanMarking, Address } from './models'
...
export class UserResolver {
  ...
  resolveAddress(@Parent() user: User): Promise<Address | null> {
    return this.nationalRegistryService.getAddress(user.houseCode)
  }
}
