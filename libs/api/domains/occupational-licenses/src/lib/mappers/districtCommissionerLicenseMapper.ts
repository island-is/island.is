...
import { DistrictCommissionersLicenseDto, DistrictCommissionersLicenseInfoDto, DistrictCommissionersLicenseStatus } from '@island.is/clients/district-commissioners-licenses'
import { isDefined } from '@island.is/shared/utils'

export const mapDistrictCommissionersLicensesResponse = (licenses: DistrictCommissionersLicenseInfoDto[], user: User, locale: Locale): Array<License> =>
{
  return licenses
    ?.map((l) => {
...
export const  mapDistrictCommissionersLicense = (license:  DistrictCommissionersLicenseDto, user: User, locale: Locale): License => {
  const licenseId = addLicenseTypePrefix(
