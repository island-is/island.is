...
export class ApplicationAdminV2Service {
  ...
  async findAllSuperAdmin(
    ...
    // Veit ekki hvort við getum notað ApplicationCard, en það er notað á mínum síðum og væri nice að geta samnýtt.
    ...
    const [appSystemSettled, formSystemSettled] =
      await Promise.allSettled([
        ...
        // TODOy útfæra endapunkt í form-system
    ...
    //TODOy: Til að styðja við paging í báðum kerfum þurfum við bæði date og síðan id sem tie-breaker ef date er jafnt.
