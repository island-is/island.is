  ...
  describe('mapFullAddress', () => {
    describe('should concatenate addresses', () => {
      ...
      it('should map on all arguments', () => {
        expect(mapFullAddress('Hraunhólar 10090', '101', 'Reykjavík')).toMatch(
          'Hraunhólar 10090, 101 Reykjavík',
        )
      })
      it('should abort if no arguments', () => {
        expect(mapFullAddress(undefined, undefined, undefined)).toBeUndefined()
      })
    })
  })
})
