...
export function DocumentInfoDTOFromJSONTyped(
  json: any,
  ...
  return {
    ...
    documentDate: !exists(json, 'documentDate')
      ? undefined
      : new Date(json['documentDate']),
    senderKennitala: !exists(json, 'senderKennitala')
      ? undefined
      : json['senderKennitala'],
    ...
    withdrawnReason: !exists(json, 'withdrawnReason')
      ? undefined
      : json['withdrawnReason'],
    minumumAuthenticationType: !exists(json, 'minumumAuthenticationType')
      ? undefined
      : json['minumumAuthenticationType'],
  }
}
  ...
  return {
    ...
    documentDate:
      value.documentDate === undefined
        ? undefined
        : value.documentDate.toISOString(),
