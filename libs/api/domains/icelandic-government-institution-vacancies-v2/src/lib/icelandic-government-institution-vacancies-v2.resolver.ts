...
import { IcelandicGovernmentInstitutionVacanciesV2Response } from './dto/icelandicGovernmentInstitutionVacanciesResponse'
...
export class IcelandicGovernmentInstitutionVacanciesResolver {
  constructor(
    private readonly vacancyService: IcelandicGovernmentInstitutionVacanciesV2Service,
  ...
  private async getVacanciesFromExternalSystem(
    ...
    try {
      vacancies = (await this.vacancyService.getVacancies({
        page: 1,
