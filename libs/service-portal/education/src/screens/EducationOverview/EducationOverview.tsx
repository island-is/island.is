      ...
      navigation={[
        {
          ...
          image: '/minarsidur/assets/images/educationDegree.svg',
          link: {
            title: defineMessage({
        ...
        },
        {
          ...
          image: '/minarsidur/assets/images/educationLicense.svg',
          link: {
            title: defineMessage({
        ...
        },
        {
          ...
          image: '/minarsidur/assets/images/educationGrades.svg',
          link: {
            title: defineMessage({
