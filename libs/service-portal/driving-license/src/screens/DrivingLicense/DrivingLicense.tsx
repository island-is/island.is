    ...
    <Box marginBottom={[6, 6, 10]}>
      <Stack space={[6, 6, 10]}>
        ...
        {(nationalRegistryUser?.age || 0) >=
          ...
          <Application
            heading={defineMessage({
              id: 'sp.driving-license:driving-license-general-license-title',
        ...
        {(nationalRegistryUser?.age || 0) >= ELIGABLE_FOR_RENEWAL_AGE && (
          <Application
            heading={defineMessage({
              id: 'sp.driving-license:driving-license-renewal-heading',
              defaultMessage: 'Endurnýjun ökuskírteinis vegna aldurs',
            })}
            subText={defineMessage({
              id: 'sp.driving-license:driving-license-renewal-subtext',
              defaultMessage:
