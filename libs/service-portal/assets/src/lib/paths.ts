export enum AssetsPaths {
  ...
  AssetsVehiclesBulkMileageUpload = '/eignir/okutaeki/magnskraning-kilometrastodu/hlada-upp',
  AssetsVehiclesBulkMileageJobOverview = '/eignir/okutaeki/magnskraning-kilometrastodu/runuverk',
  AssetsVehiclesBulkMileageJobDetail = '/eignir/okutaeki/magnskraning-kilometrastodu/runuverk/:id',
