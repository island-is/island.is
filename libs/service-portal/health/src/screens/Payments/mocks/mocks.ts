...
const useMockQuery = <T>(
  data: T,
  loadTime: number | undefined = 1000,
): MockResponse<T> => {
...
export const useGetMockPaymentOverviewStatusQuery =
  (): MockResponse<RightsPortalPaymentOverviewStatusResponse> => {
    const { data, loading, error } =
      useMockQuery<RightsPortalPaymentOverviewStatusResponse>({
        items: [
          {
            credit: 15372,
            debit: 0,
...
export const useGetMockPaymentOverviewBillsQuery =
  (): MockResponse<RightsPortalPaymentOverviewBillResponse> => {
    const { data, loading, error } =
      useMockQuery<RightsPortalPaymentOverviewBillResponse>({
        items: [
          {
            date: '2022-12-14',
...
export const useGetMockPaymentOverviewDocumentQuery = (
  options: InputOptions<RightsPortalPaymentOverviewDocumentInput>,
): MockResponse<RightsPortalPaymentOverviewDocumentResponse> => {
  const { data, loading, error } =
    useMockQuery<RightsPortalPaymentOverviewDocumentResponse>({
      items:
        options.input.documentId !== 44
          ? []
          : [
              {
                fileName: 'bill.pdf',
...
export const useGetMockCopaymentStatusQuery =
  (): MockResponse<RightsPortalCopaymentStatusResponse> => {
    const { data, loading, error } =
      useMockQuery<RightsPortalCopaymentStatusResponse>({
        items: [
          {
            insuranceStatus: {
...
export const useGetMockCopaymentPeriodsQuery =
  (): MockResponse<RightsPortalCopaymentPeriodResponse> => {
    const { data, loading, error } =
      useMockQuery<RightsPortalCopaymentPeriodResponse>(
        {
          items: [
            {
              id: 1,
...
export const useGetMockCopaymentPeriodBillsQuery = (
  options: InputOptions<RightsPortalCopaymentBillsInput>,
): MockResponse<RightsPortalCopaymentBillResponse> => {
  const { data, loading, error } =
    useMockQuery<RightsPortalCopaymentBillResponse>(
      {
        items: [
          {
            id: 1,
