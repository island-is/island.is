...
export const PaymentPartication = () => {
  ...
  const [getPeriodBillsLazyQuery] = useGetCopaymentBillsLazyQuery({})
  ...
  //                       <T.Data>{bill.status}</T.Data>
  //                       <T.Data>{bill.month}</T.Data>
  //                       <T.Data>
  //                         {formatMessage(messages.medicinePaymentPaidAmount, {
  //                           amount: bill.maximumPayment,
  //                         })}
  //                       </T.Data>
  //                       <T.Data>
  //                         {formatMessage(messages.medicinePaymentPaidAmount, {
  //                           amount: bill.monthPayment,
  //                         })}
  //                       </T.Data>
  //                       <T.Data>
  //                         {formatMessage(messages.medicinePaymentPaidAmount, {
