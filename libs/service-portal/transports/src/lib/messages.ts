...
export const messages = defineMessages({
  ...
  introDescriptionFirst: {
    id: 'sp.transports:intro-description-first',
    defaultMessage:
  ...
  introDescriptionLink: {
    id: 'sp.transports:intro-description-link',
    defaultMessage: 'notendaskilmála',
  },
  introDescriptionSecond: {
    id: 'sp.transports:intro-description-second',
    defaultMessage: ' Loftbrúar',
  },
  introLink: {
    id: 'sp.transports:intro-link',
    defaultMessage:
  ...
  attention: {
    id: 'sp.transports:attention',
    defaultMessage: 'Athugið',
  },
  codeRenewalText: {
    id: 'sp.transports:code-renewal-text',
    defaultMessage: 'Kóðinn endurnýjast eftir 1 notkun (gildir í 24 klst.)',
  },
  myRights: {
    id: 'sp.transports:my-rights',
    defaultMessage: 'Mín réttindi',
  },
  remainingAirfares: {
    id: 'sp.transports:remaining-airfares',
  ...
  copyCode: {
    id: 'sp.transports:copy-code',
    defaultMessage: 'Afrita kóða',
  },
  copied: {
    id: 'sp.transports:copied',
    defaultMessage: 'Afritað',
  },
  codeCopiedSuccess: {
    id: 'sp.transports:code-copied-success',
    defaultMessage: 'Afritun tókst',
  },
  airfaresUsage: {
    id: 'sp.transports:airfares-usage',
    defaultMessage: 'Notkun á núverandi tímabili',
  },
  user: {
    id: 'sp.transports:user',
    defaultMessage: 'Notandi',
  },
  flight: {
    id: 'sp.transports:flight',
    defaultMessage: 'Flugleið',
  },
  activeConnectionCodes: {
    id: 'sp.transports:active-connection-codes',
    defaultMessage: 'Virkir afsláttarkóðar fyrir áframhaldandi flug',
  },
  validTo: {
    id: 'sp.transports:valid-to',
    defaultMessage: 'Gildir til',
  },
  noRights: {
    id: 'sp.transports:no-rights',
    defaultMessage: 'Enginn réttur',
  },
  noRightsText: {
    id: 'sp.transports:no-rights-text',
    defaultMessage:
