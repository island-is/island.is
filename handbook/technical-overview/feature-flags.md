...
3. Make sure that the CONFIGCAT_SDK_KEY environment variable is in `.env.secret` in the root of the repository. You can fetch it by calling `yarn get-secrets service-portal`.
