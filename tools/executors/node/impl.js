      ...
      switch (_a.label) {
        case 0:
          ...
          if (!options.watch) {
            ...
            options.tsConfig = utils_1.createTmpTsConfig(
              options.tsConfig,
              context.root,
              projectInfo.root,
            )
          ...
          if (
            options.externalDependencies === EXTERNAL_DEPENDENCIES_DEFAULT_VALUE
          ) {
        ...
        case 1:
          return [
            5 /*yield**/,
            tslib_1.__values(
              tslib_1.__asyncDelegator.apply(void 0, [
                tslib_1.__asyncValues.apply(void 0, [_a.sent()]),
              ]),
            ),
          ]
        case 2:
