...
const steps = [
    enableNodeModules ? generateCacheAction(
        "Cache node_modules",
        "node-modules",
        "node_modules",
        keys["node-modules-key"],
    ) : null,
    enableMobileNodeModules ? generateCacheAction(
        "Cache Mobile node_modules",
        "mobile-node-modules",
        "apps/native/app/node_modules",
        keys["mobile-node-modules-key"],
    ) : null,
    enableGeneratedFiles ? generateCacheAction(
        "Cache Generated Files",
        "generated-files",
        "generated_files.tar.gz",
        keys["generated-files-key"],
    ) : null,
    enableCypress ? generateCacheAction(
        "Cache Cypress",
        "cypress-cache",
        cypressPath,
...
const workflow = { ...createHeader("Autogenerated cache workflow", "Autogenerated"), ...createOutputs(steps), ...createRuns(steps) };
