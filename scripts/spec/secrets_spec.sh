...
Describe 'create-scripts tests'
  Include sh/create-secret.sh
  Describe 'Secrets'
    It 'validates output from error function'
      When call __error_exit 'this broke' # this is evaluation
      # The output should eq "[ERROR]: this broke"
      The status should be failure
    End
    It 'validates string does not end with slash'
      When call validate_slash '/k8s/some/secret/' # this is evaluation
      The status should be failure
    End
