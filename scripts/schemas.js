 ...
 */
const TARGETS = [
  'schemas/external-openapi-generator', // If we depend on external services that comes with theirs own .yml file (RC and not documented yet)
  'schemas/build-openapi', // Output openapi.yml
  'schemas/openapi-generator', // Output gen/fetch/* based on openapi.yml to run openapi-generator
